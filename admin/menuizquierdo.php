      ...
      <?php } ?>
       <?php if (isset($_SESSION['login_usuario'])){ ?>
        ...
        <ul class="nav">
                ...
                <div class="collapse <?=$actibtn;?> " id="pagesExamples">
                    <ul class="nav">
						...
						<li class="nav-item <?=$activeblog;?>">
                            <a class="nav-link" href="form-blog.php">
                              <i class="material-icons">receipt</i>
                              <span class="sidebar-normal"> Blog </span>
                            </a>
                        </li>
						<li class="nav-item <?=$activehisb;?>">
                            <a class="nav-link" href="historial-busquedas.php">
                              <i class="material-icons">receipt</i>
                              <span class="sidebar-normal"> Historial Busquedas </span>
                            </a>
                        </li>
			...
			<li class="nav-item <?=$activedos;?>">
                <a class="nav-link" data-toggle="collapse" href="#pagesExamples2" <?=$cambiaicondos;?> >
                    <i class="material-icons">settings</i>
                    <p> Tablas Maestras
                       <b class="caret"></b>
                    </p>
                </a>
				<div class="collapse <?=$actibtndos;?> " id="pagesExamples2">
                    <ul class="nav">
                        <li class="nav-item <?=$activerptados;?>">
                            <a class="nav-link" href="rpt-sector.php">
                              <i class="material-icons">receipt</i>
						...
						<li class="nav-item <?=$activerptaaar;?>">
                            <a class="nav-link" href="">
                              <i class="material-icons">receipt</i>
                              <span class="sidebar-normal"> Arancel </span>
                            </a>
                        </li>
						<li class="nav-item <?=$activerptaemmp;?>">
                            <a class="nav-link" href="">
                              <i class="material-icons">receipt</i>
                              <span class="sidebar-normal"> Empresas </span>
                            </a>
