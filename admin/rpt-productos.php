...
if($pkid!=""){//eliminamos registro
	$Sql="UPDATE productos SET estado='E' WHERE idcod ='$pkid' ";
...
<div class="card ">
    ...
    <div class="card-icon">
                        ...
                        <h4 class="card-title">Historial Productos</h4>
    </div>
<form class="" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
	<div class="row"> 
		...
		<div class="col-lg-5">
	<label>Ingresar datos a consultar por: n&uacute;mero de partida o descripcion del producto</label>
		...
		<div class="col-lg-2"><br>
			<a href="form-producto.php" target="_blank" class="btn btn-primary">Nuevo Registro</a>
		</div>
		<div class="col-lg-2"><br>
			<a href="productos_excel.php" target="_blank" class="btn btn-success">Exportar Excel</a>
		</div>
	</div>
	</form>
</div>
...
p.origen_expor,
p.origen_impor,
p.impo_vfobusdserdol1,
p.impo_vfobusdserdol2,
p.impo_vfobusdserdol3,
p.impo_vfobusdserdol4,
p.impo_vpesnet1,
p.impo_vpesnet2,
p.impo_vpesnet3,
p.impo_vpesnet4,
...
FROM
productos as p
WHERE p.estado='A' AND CONCAT_WS('',p.partida_nandi,' ',p.prod_generico,' ',p.partida_desc) like '%$valregc%' 
ORDER BY
p.idcod DESC";
...
echo "<td><a onclick='return confirmar2()' href='rpt-productos.php?log=$codi&by=del'><button class='btn btn-danger btn-xs'> <i class='material-icons'>delete_forever</i> </button></a></td>";
