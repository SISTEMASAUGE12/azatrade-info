...
SUM(CASE e.aniofn WHEN '2024' THEN e.VFOBSERDOL ELSE 0 END) AS f2024,
...
FROM GranResumenExport_PowerBI as e WHERE e.aniofn >= '2020' AND e.aniofn <= '2024' GROUP BY e.PART_NANDI ORDER BY e.PART_NANDI ASC";
...
if($res_gral->num_rows>0){ 
		  ...
		  $datonomp7x= $fila_rpt['p2024'];
		  $datonomp8x= $fila_rpt['f2024'];
