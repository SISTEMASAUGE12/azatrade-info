			...
			<form id="myForm">
							<div class="row">
								...
								<div class="col-lg-3">
									...
									<input type="text" class="form-control" placeholder="Producto" name="nameprodu" id="nameprodu" onfocus="this.value=''" >
								</div>
								
							<div class="col-lg-3">
							<select class="form-control-lg" style="width: 280px;" id='qp' name="qp" lang="es" onfocus="this.value=''" >
