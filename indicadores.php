   ...
   <div class="page-wrapper">
    ...
    <div class="container">
        <ul style="list-style-type: decimal;
            padding-left: 20px;">
                     <li><a href="compradores-internacionales-clasificados" target="_blank">Compradores internacionales clasificados </a></li>
                     <li><a href="evaluacion-precios-exportacion" target="_blank">Evaluación de precios de exportación </a></li>
                     <li>Indicadores 1995 – 2023 
                        <ul>
                           <li><a href="indicadores-por-sectores" target="_blank">3.1. Indicadores por sectores</a></li>
                           <li><a href="indicadores-totales" target="_blank">3.2. Indicadores totales</a></li>
                           <li><a href="evaluacion-empresas-exportadoras-peruanas" target="_blank">3.3. Evaluación de empresas exportadoras peruanas</a></li>
                           <li><a href="subpartidas" target="_blank">3.4. Subpartidas</a></li>
                        </ul>
                     </li>
                     <li>
                        Análisis de una subpartida 2012 -2023
                        <ul>
                           <li><a href="exportaciones-mundiales-hs6" target="_blank">4.1. Exportaciones mundiales HS6</a></li>
                           <li><a href="exportaciones-peruanas" target="_blank">4.2. Exportaciones peruanas</a></li>
                           <li><a href="analisis-precios-exportacion" target="_blank">4.3. Análisis de precios de exportación</a></li>
                           <li><a href="estacionalidades" target="_blank">4.4. Estacionalidades</a></li>
                           <li><a href="supervivencia-empresas-exportadoras" target="_blank">4.5. Análisis de supervivencia de empresas exportadoras</a></li>
                           <li><a href="entrada-salida-empresas" target="_blank">4.6. Entrada y salida de empresas</a></li>
                           <li><a href="concentracion-empresas" target="_blank">4.7. Concentración de empresas</a></li>
                           <li><a href="concentracion-mercados" target="_blank">4.8. Concentración de mercados</a></li>
                           <li><a href="exportaciones-nominales-reales" target="_blank">4.9. Exportaciones nominales y reales</a></li>
                        </ul>
                     </li>
                     <li>
                        Reportes 2012 – 2024 
                        <ul>
                           <li><a href="empresas-valor-fob" target="_blank">5.1. Empresas – Valor FOB</a></li>
                           <li><a href="empresas-comparativo" target="_blank">5.2. Empresas – Comparativo</a></li>
                           <li><a href="mercados-valor-fob" target="_blank">5.3. Mercados – Valor FOB</a></li>
                           <li><a href="mercados-comparativo" target="_blank">5.4. Mercados – Comparativo</a></li>
                           <li><a href="departamentos-valor-fob" target="_blank">5.5. Departamentos – Valor FOB</a></li>
                           <li><a href="departamentos-comparativo" target="_blank">5.6. Departamentos – Comparativo</a></li>
                           <li><a href="sectores-valor-fob" target="_blank">5.7. Sectores – Valor FOB</a></li>
                           <li><a href="sectores-comparativo" target="_blank">5.8. Sectores – Comparativo</a></li>
                           <li><a href="aduanas-valor-fob" target="_blank">5.9. Aduanas – Valor FOB</a></li>
                           <li><a href="subpartidas-valor-fob" target="_blank">5.10. Subpartidas – Valor FOB</a></li>
                           <li><a href="subpartidas-peso-neto-kg" target="_blank">5.11. Subpartidas – Peso Neto Kg</a></li>
                           <li><a href="subpartidas-comparativo" target="_blank">5.12. SubPartidas Comparativo</a></li>
                        </ul>
                     </li>
                     <li>Perfiles </li>
                  </ul>
            ...
            <div class="row">
               ...
               <div class="col-lg-12">
                  ...
                  <div id="loader" class="text-center">
                     <center><img src="assets/images/loading-carga.gif" width="180px">Procesando Datos, espere un momento por favor...</center>
                  </div>
