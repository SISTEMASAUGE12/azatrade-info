...
if($rdrpt -> rowCount() > 0) { 
	...
	$sqlinsert="INSERT INTO busquedas(fechareg, horareg, pagek, origen, seccion, palabra)values(now(), now(), 'www.azatrade.info/importacion', 'Importacion', 'Empresas', '$dato2 - $dato', '$dato3' )";
...
<?php }else{ ?>
      <div class="col-sm-12 col-6 product-default left-details product-list mb-2">
                                <div class="product-details">
                                    <h3 class="product-title"> No se encontraron datos <?=$dato2;?> - <?=$dato;?> </h3>
                                </div>
                            </div>
      <?php
	}
