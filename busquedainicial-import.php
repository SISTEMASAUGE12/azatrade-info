...
$date_past = date('Y-m-d', $date_past);
	  ...
	  $dqlft = "SELECT p.anio, p.partida as part_nandi, p.descri, SUM(p.fob) as vfobx1, SUM(p.flete) as flete, SUM(p.seguro) as seguro, SUM(p.cif) as cif, SUM(p.pesoneto) as VPESNET, (case p.pesoneto when 0 then 0 else (p.fob/p.pesoneto) end) as precioporkl FROM tM".$dato2."_Consulta_desc AS p WHERE p.anio='$dato2' AND p.descri like '%$dato%' GROUP BY p.anio, p.partida ORDER BY vfobx1 DESC ";
...
if($rdrpt -> rowCount() > 0) { 
	...
	$sqlinsert="INSERT INTO busquedas(fechareg, horareg, pagek, origen, seccion, palabra, codeuser)values(now(), now(), 'www.azatrade.info/importacion', 'Importacion', 'Productos', '$dato2 - $dato', '$dato4' )";
					...
					<div class="row">
						<div class="col-xl-3 col-md-6">
							<div class="info-box info-box-icon-left">
								...
								<div class="info-box-content">
									<h4>Ver Detalle</h4>
									<p><a href="ver-resumen-detalle-partida-impo?dat=<?=$dato;?>&year=<?=$dato2;?>&pk=<?=$tbb2;?>" target="_blank"> <button class="btn btn-outline-primary btn-rounded btn-md">Ver Reporte</button></a></p>
								</div>
							</div>
						</div>
						<!--<div class="col-xl-3 col-md-6">
						...
						<div class="col-xl-3 col-md-6">
							<div class="info-box info-box-icon-left">
								...
								<div class="info-box-content">
									...
									<p><a href="partida-indicador-impo-anual?dat=<?=$tbb2;?>" target="_blank"> <button class="btn btn-outline-primary btn-rounded btn-md">Ver Reporte</button></a></p>
								</div>
							</div>
						</div>
						<div class="col-xl-3 col-md-6">
							<div class="info-box info-box-icon-left">
								...
								<div class="info-box-content">
									...
									<p><a href="partida-indicador-impo-mensual?dat=<?=$tbb2;?>&year=<?=$dato2;?>" target="_blank"> <button class="btn btn-outline-primary btn-rounded btn-md">Ver Reporte</button></a></p>
								</div>
							</div>
						</div>
						<div class="col-xl-3 col-md-6">
							<div class="info-box info-box-icon-left">
								...
								<div class="info-box-content">
									...
									<p><a href="partida-estacionalidad-impo?dat=<?=$tbb2;?>&year=<?=$dato2;?>&var=FOBUSD" target="_blank"> <button class="btn btn-outline-primary btn-rounded btn-md">Ver Reporte</button></a></p>
								</div>
							</div>
						</div>
						<div class="col-xl-3 col-md-6">
							<div class="info-box info-box-icon-left">
								...
								<div class="info-box-content">
									<h4>Mercados Origen</h4>
									<p><a href="partida-mercados-impo?dat=<?=$tbb2;?>&year=<?=$dato2;?>&var=FOBUSD" target="_blank"> <button class="btn btn-outline-primary btn-rounded btn-md">Ver Reporte</button></a></p>
								</div>
							</div>
						</div>
						<!--<div class="col-xl-3 col-md-6">
						...
						<div class="col-xl-3 col-md-6">
							<div class="info-box info-box-icon-left">
								...
								<div class="info-box-content">
									<h4>Empresas Importadoras</h4>
									<p><a href="partida-empresas-impo?dat=<?=$tbb2;?>&year=<?=$dato2;?>&var=FOBUSD" target="_blank"> <button class="btn btn-outline-primary btn-rounded btn-md">Ver Reporte</button></a></p>
								</div>
							</div>
						</div>
						...
						<div class="row">
						<div class="col-lg-6">
							<center><a href="descarga_partidamasiva_import.php?dat1=<?=$tbb2;?>&dat2=<?=$dato2;?>" target="_blank" class="btn btn-primary">Descarga un año</a></center>
						</div>
						<div class="col-lg-6">
								<center><a href="descarga_partidamasiva_import.php?dat1=<?=$tbb2;?>" target="_blank" class="btn btn-primary">Descarga todo los años</a></center>
						</div>
						</div>
