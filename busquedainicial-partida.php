...
if($rdrpt -> rowCount() > 0) { 
	...
	$sqlinsert="INSERT INTO busquedas(fechareg, horareg, pagek, origen, seccion, palabra, codeuser)values(now(), now(), 'www.azatrade.info', 'Exportacion', 'Partida', '$dato2 - $dato', '$dato3' )";
