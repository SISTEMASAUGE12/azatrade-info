                 ...
                 <div class="info-boxes-container row row-joined mb-2 font2">
                    ...
                    <div class="info-box info-box-icon-left col-lg-4">
                        ...
                        <div class="info-box-content">
                            ...
                            <p class="text-body"> │ Fecha Numeración │ Valor FOB USD │ </p>
                        </div>
                    </div>
                    <div class="info-box info-box-icon-left col-lg-4">
...
FROM GranResumenImport_PowerBI as e WHERE e.part_nandi = '$code1' AND e.aniofn >= '2012' AND e.aniofn <= '$aniogen' GROUP BY mes ORDER BY mes";
...
foreach($ggts as $dsx) {
	...
	echo "<td>".number_format($listval14,0)."</td>";
	echo "</tr>";
}
	echo "<tr>";
	echo "<td> </td>";
