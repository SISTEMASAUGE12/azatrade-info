...
foreach($glds as $shht) {
 ...
 if($filaff1=="1"){
	...
	<center><a href='descarga_partidamasiva.php?dat1=<?=$code3;?>&dat2=<?=$code2;?>' target='_blank' class='btn btn-primary'>Descarga un año</a> </center>
	</div>
	<div class='col-lg-3'><br>
	<center><a href='descarga_partidamasiva.php.php?dat1=<?=$code3;?>' target='_blank' class='btn btn-primary'>Descarga todo los años</a></center>
	</div>
		<div class='col-lg-3'></div>
	</div>
				</section>
