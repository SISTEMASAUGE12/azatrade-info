                 ...
                 <div class="info-boxes-container row row-joined mb-2 font2">
                    <div class="info-box info-box-icon-left col-lg-4">
                        ...
                        <div class="info-box-content">
                            <h4>Reporte de Mercados Origen </h4>
                    ...
                    <div class="col-lg-12" style="padding: 28px;">
						...
						<table id='datatablese' class='table table-striped table-no-bordered table-hover compact' cellspacing='0' width='100%' style='width:100%'>
                          ...
                          <tr>
							...
							<tbody>
						<?php		
$sqtrp="SELECT e.pais_orige, paises.espanol,
...
FROM GranResumenImport_PowerBI as e LEFT JOIN paises ON e.pais_orige = paises.idpaises 
WHERE e.part_nandi = '$code1' AND e.aniofn >= '2012' AND e.aniofn <= '$aniogen' 
GROUP BY e.pais_orige, paises.espanol ORDER BY a2023 DESC";
...
foreach($ggts as $dsx) {
	...
	echo "<td>".number_format($listval14,2)."</td>";
	echo "</tr>";
}
	echo "<tr>";
	echo "<td> </td>";
