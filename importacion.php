...
<!-- tab -->
			<div class="tabs tabs-simple">
                    ...
                    <div class="header-right w-lg-max pl-2">
						...
						<div class="header-searchp header-iconp header-search-inlinep header-search-categoryp w-lg-max" style="display: flex; justify-content: center;">
							<!-- <form> -->
								<div class="header-search-wrappep">
                                    ...
                                    <button class="btn icon-magnifier p-0" type="button" id="busca" name="busca"></button>
									<?php }else{ ?>
									<a href="login" class="btn icon-magnifier p-0"></a>
									<?php } ?>
								</div>
							<!--</form>-->
						</div>
						...
						<!-- <div class="header-searchp header-iconp header-search-inlinep header-search-categoryp w-lg-max" style="display: flex; justify-content: center;">
                                <div class="header-search-wrappep" style="border: solid 2px #16B803;">
									<input type="hidden" id="buscasql" name="buscasql" value="produ">
                                    <input type="search" class="form-control" name="q" id="q" placeholder="buscar..." onkeyup="onKeyUp(event)">
									<div class="select-customp">
                                        <select id="year" name="year">
						...
						<div class="header-icon header-search header-search-inline header-search-category w-lg-max text-right mt-0">
							<form>
								<div class="header-search-wrapper">
                                    ...
                                    <!--<input type="search" class="form-control" name="qxx" id="qxx" placeholder="buscar..." onkeyup="onKeyUp(event)">-->
									<select id='cate2' name="cate2" lang="es" class="form-control">
									...
									<?php if (isset($_SESSION['login_usuario'])){ ?>
                                    <button class="btn icon-magnifier p-0" type="button" id="busca2" name="busca2"></button>
									<?php }else{ ?>
									<a href="login" class="btn icon-magnifier p-0"></a>
									<?php } ?>
								</div>
	...
	$filaff7x1 = $shht -> clasificacion4;
							...
							<div class="product-default inner-quickview inner-icon">
                                ...
                                <div class="product-details">
                                    ...
                                    <h3 class="product-title"> <a href="partida-detalle-uso-general?dat=<?=$filaff2;?>&year=2022" target="_blank" style="color: #2927D5;">Partida: <?=$filaff2;?> </a> </h3>
                                    <div class="price-box">
   ...
   $("#cate2").select2({
	...
	<script>
      ...
      function load(page){
        ...
        $("#loader").fadeIn();
        $.ajax({
		  url : 'busquedainicial-import.php?data='+product+'&year='+proyear+'&ptipo1='+ptipo1+'&use='+codereg,
          data : parametros,
        ...
        $("#loader").fadeIn();
        $.ajax({
		  url : 'busquedainicial-merca-import.php?data='+product+'&year='+proyear+'&ptipo1='+ptipo1+'&use='+codereg,
          data : parametros,
          beforeSend:function(objeto){
            $("#loader").fadeIn();
          },
		...
		function load3(page){
		  product = encodeURIComponent(document.getElementById("q2").value); //encodeURIComponent: permite pasar en la variable caracteres especiales como:  , / ? : @ & = + $ #
        ...
        $("#loader").fadeIn();
        $.ajax({
		  url : 'busquedainicial-empresas-import.php?data='+product+'&year='+proyear+'&use='+codereg,
          data : parametros,
          beforeSend:function(objeto){
            $("#loader").fadeIn();
          },
        ...
        $("#loader").fadeIn();
        $.ajax({
		  url : 'busquedainicial-partida-uso.php?data='+product+'&year='+proyear+'&use='+codereg,
          data : parametros,
          beforeSend:function(objeto){
            $("#loader").fadeIn();
          },
