...
echo "<td bgcolor='#EBEBEB'><b><center>Primer Trimestre</center></b></td>";
echo "<td bgcolor='#EBEBEB'><b><center>Segundo Trimestre</center></b></td>";
echo "<td bgcolor='#EBEBEB'><b><center>Trecer Trimestre</center></b></td>";
echo "<td bgcolor='#EBEBEB'><b><center>Cuarto Trimestre</center></b></td>";
...
echo "<tr onmouseover='NavRollOver(this)' onmouseout='NavRollOut(this)'> ";
	...
	echo "</tr> ";
	echo "<tr onmouseover='NavRollOver(this)' onmouseout='NavRollOut(this)'> ";
	echo "<td colspan='7'><a href='exportatrimes.php?sectx=$sectx&depax=$depax&prodx=$prodx&medx=$medx&perix=$perix'>Exportar a: <img src='img/EXCEL.png' width='30' height='30' title='Excel'/></a></td> ";
	echo "</tr> ";
