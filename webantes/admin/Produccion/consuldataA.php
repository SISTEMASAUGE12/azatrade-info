...
echo "<tr onmouseover='NavRollOver(this)' onmouseout='NavRollOut(this)'> ";
	...
	echo "</tr> ";
	echo "<tr onmouseover='NavRollOver(this)' onmouseout='NavRollOut(this)'> ";
	echo "<td colspan='8'><a href='exportaanualt.php?sectx=$sectx&depax=$depax&prodx=$prodx&medx=$medx'>Exportar a: <img src='img/EXCEL.png' width='30' height='30' title='Excel'></a></td> ";
	echo "</tr> ";
