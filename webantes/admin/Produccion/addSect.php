...
$cod= $_GET["cod"];
$sqlp="SELECT id, sector, eliminado
FROM sector
...
function valida(regsect) {
    if (regsect.nomsect.value.length < 1){
	
		alert("Ingrese Nombre del Sector");
		return false;
	}
	return true;
}
...
<br>
<center>
<form name="regsect" method="post" action="insertmodifsect.php"  onSubmit="return valida(this);">
<table border="1" bordercolor="#00CCFF" style='background-color:#CEECF5;
   ...
   <tr onmouseover='NavRollOver(this)' onmouseout='NavRollOut(this)'>
    <td bgcolor="#279CC9" colspan="2" align="center"><b><font color="#FFFFFF">Registrar Sector</font></b></td>
  </tr>
  <tr onmouseover='NavRollOver(this)' onmouseout='NavRollOut(this)'>
    <td>Nombre Sector:</td>
    <td><input name="nomsect" type="text" size="30" value="<? echo $sec; ?>"  />
    <input name="ase" type="hidden" size="15" value="<? echo $idse; ?>"  /></td>
  </tr>
