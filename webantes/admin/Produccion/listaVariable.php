...
variable.variable ASC LIMIT ".$mysqli->real_escape_string($_GET['limit'])." OFFSET ".$mysqli->real_escape_string($_GET["offset"]);
		...
		while($fila = $resultado ->fetch_assoc())
		{
			...
			$jsondataperson["editar"] = "<a href='addVari.php?cod=$cod'><img src='img/editar.png' width='20' height='18' title='Editar Registro'></a>";
			$jsondataperson["eliminar"] = "<a href='deletevar.php?cod=$cod'><img src='img/delete.png' width='20' height='18' title='Eliminar Registro'></a>";
