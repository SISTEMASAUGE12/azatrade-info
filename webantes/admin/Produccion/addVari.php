...
include ("menu.php");
$cod= $_GET["cod"];
$sqlp="SELECT id, variable, eliminado
FROM variable
...
function valida(regvaria) {
    if (regvaria.vari.value.length < 1){
	
		alert("Ingrese Nombre de Variable");
		return false;
	}
	return true;
}
...
<br>
<center>
<form name="regvaria" method="post" action="insertmodifvar.php" onSubmit="return valida(this);">
<table border="1" bordercolor="#00CCFF" style='background-color:#CEECF5;
   ...
   <tr onmouseover='NavRollOver(this)' onmouseout='NavRollOut(this)'>
    <td bgcolor="#279CC9" colspan="2" align="center"><b><font color="#FFFFFF">Registrar Variable</font></b></td>
  </tr>
  <tr onmouseover='NavRollOver(this)' onmouseout='NavRollOut(this)'>
    <td>Nombre Variable:</td>
    <td><input name="vari" type="text" size="30"  value="<? echo $var; ?>" />
    <input name="idv" type="hidden" size="15" value="<? echo $idv; ?>"  />
    </td>
  </tr>
