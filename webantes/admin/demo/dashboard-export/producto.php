			...
			<div class="col-lg-12 col-12">
					  <div class="box">
						...
						<form class="form" method="post">
							<div class="box-body">
								<h4 class="box-title text-info mb-0"><i class="ti-search me-15"></i> Seleccionar las opciones e ingresa descripción del producto</h4>
								<hr class="my-15">
								<div class="row">
								  <div class="col-md-3">
...
foreach($djfros as $filavc) {
	...
	echo "<option value=''>Sin Datos</option>";
								  ...
								  <div class="col-md-3">
									<div class="form-group">
									  <label class="form-label">Seleccioonar Año <small class="text-danger"><b>(*)</b></small></label>
									  <select name="selecyear" id="selecyear" class="form-select">
                ...
                <option value="2012" <?php if($_POST['selecyear']=="2012"){echo "selected";}?>>2012</option>
								  ...
								  <div class="col-md-3">
									<div class="form-group">
									  <label class="form-label">Descripci&oacute;n del Producto <small class="text-danger"><b>(*)</b></small> </label>
									  <input type="text" name="dato" id="dato" class="form-control" placeholder="Ejm: uva">
									</div>
								  </div>
								  <div class="col-md-3">
									<div class="form-group">
