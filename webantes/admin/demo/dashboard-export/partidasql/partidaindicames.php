...
$partida1 = trim($_POST["partidaindimen"]);
$ubicod1 = trim($_POST["codubimen"]);
$dato3 = trim($_POST["namedepamen"]);
...
foreach($trepos as $fila_vfob) {
	...
	$vfobmes12=  $fila_vfob -> mes12;
			   ...
			   $sumtota = number_format(($vfob_2012 + $vfob_2013 + $vfob_2014 + $vfob_2015 + $vfob_2016 + $vfob_2017 + $vfob_2018 + $vfob_2019 + $vfob_2020 + $vfob_2021 + $vfobmes11 + $vfobmes12),2);
...
$query_preciousd = "SELECT 'preciousdxkg' as VALOR,
	   ...
	   FROM exportacion where extract(year from exportacion.fnum) = '$anio' $query1fil AND exportacion.part_nandi='$partida1'";	
$resultado_preusd = $conexpg -> prepare($query_preciousd); 
$resultado_preusd -> execute(); 
$bffpos = $resultado_preusd -> fetchAll(PDO::FETCH_OBJ); 
if($resultado_preusd -> rowCount() > 0)   { 
foreach($bffpos as $fila_preciousd) {
...
<div class="col-lg-12 col-12">
					  <div class="box">
						<div class="box-header with-border">
						  <h4 class="box-title">Reporte Mensual de Indicadores - Exportaciones</h4>
						</div>
							<div class="box-body">
								<div class="form-group">
								  <label class="form-label">Partida #: <?=$partida1;?> │ Departamento: <?=$dato3;?> │ Fecha Numeración │ Periodo <?=$anio;?> </label>
