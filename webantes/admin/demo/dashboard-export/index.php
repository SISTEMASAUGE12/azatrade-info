  ...
  <div class="content-wrapper">
	  <div class="container-full">
		...
		<section class="content">
			...
			<h4>Actualizacion de DATA</h4>
			Este es un ejemplo.</a>
		  </div>
			...
			<div class="row">
			<h1 align="center"><b>Aprende y gana con AZATRADE.INFO</b></h1>
			<hr>
			<h3><b>1. Cómo obtener mi cuenta AZATRADE</b></h3>

			<div class="col-lg-6 col-12"> 
			  <div class="box">
				<div class="box-header with-border">
				  <h4 class="box-title">¿Qué es Azatrade?</h4>
				</div>
				<div class="box-body">
					<a class="popup-youtube btn btn-danger" href="www.youtube.com/watch?v=sK7riqg2mr4">Ver Video</a>
				</div>
			  </div>
			 </div>
			 ...
			 <div class="col-lg-6 col-12"> 
			  <div class="box">
				<div class="box-header with-border">
				  <h4 class="box-title">Azatrade: Registro, Cambio de Clave, Recuperación de clave</h4>
				</div>
				<div class="box-body">
					<a class="popup-youtube btn btn-danger" href="www.youtube.com/watch?v=sK7riqg2mr4">Ver Video</a>
				</div>
			 ...
			 <h3><b>2. Cómo puedo EXPORTAR con AZATRADE</b></h3>
			 <div class="col-lg-6 col-12"> 
			  <div class="box">
				<div class="box-header with-border">
				  <h4 class="box-title">¿Cómo saber si un producto se exporta?</h4>
				</div>
				<div class="box-body">
					<a class="popup-youtube btn btn-danger" href="www.youtube.com/watch?v=sK7riqg2mr4">Ver Video</a>
				</div>
			 ...
			 <div class="col-lg-6 col-12"> 
			  <div class="box">
				<div class="box-header with-border">
				  <h4 class="box-title">¿Cómo evaluar un producto o un mercado?</h4>
				</div>
				<div class="box-body">
					<a class="popup-youtube btn btn-danger" href="www.youtube.com/watch?v=sK7riqg2mr4">Ver Video</a>
				</div>
