...
FROM exportacion LEFT JOIN puerto ON exportacion.cpuedes = puerto.idcodigo WHERE exportacion.ndoc = '".$paiscode."' $querytu AND ".$wherefecha." ";
  }
  if($nombres2=="diferen"){
	  $sqlyear="SELECT
				  ...
				  <div class="col-lg-12 col-12">
					  <div class="box">
						<div class="box-header with-border">
						  <h4 class="box-title">Reporte Empresa Evoluci&oacute;n Mensual de Exportaciones</h4>
						</div>
							<div class="box-body">
