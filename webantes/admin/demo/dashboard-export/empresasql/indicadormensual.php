...
$paisname = $_POST["namempA1"];
$paiscode = $_POST["codempA1"];
$anio = $_POST["year"];

$namedepa1 = $_POST["namedepa1"];
$ubicod1 = $_POST["codubi1"];
...
foreach($cempps as $fila_emp) {
	  ...
	  $generalC = "SELECT Count(DISTINCT exportacion.cpaides) as cant_mer, extract(MONTH from exportacion.fnum) as mes FROM exportacion WHERE extract(year from exportacion.fnum)= '$anio' $querytu AND exportacion.ndoc='$paiscode' GROUP BY mes order BY mes ASC";	
...
$pmpps = $resultado_merca -> fetchAll(PDO::FETCH_OBJ); 
if($resultado_merca -> rowCount() > 0)   { 
foreach($pmpps as $fila_generaC) {
...
$res_generaC = $conexpg -> prepare($generalC); 
$res_generaC -> execute(); 
$cypps = $res_generaC -> fetchAll(PDO::FETCH_OBJ); 
if($res_generaC -> rowCount() > 0)   { 
foreach($cypps as $fila_generaC) {
...
<div class="col-lg-12 col-12">
					  <div class="box">
						<div class="box-header with-border">
						  <h4 class="box-title">Reporte Analisis Empresa Indicador Mensual - Exportaciones</h4>
						</div>
							<div class="box-body">
								<div class="form-group">
								  <label class="form-label"><b>Empresa:</b> <?=$paisname;?> <b>│ Ruc:</b> <?=$paiscode;?> <b>│ Departamento:</b> <?=$namedepa1;?> <b>│</b> Fecha Numeraci&oacute;n <b>│ Periodo: </b> <?=$anio;?> </label>
