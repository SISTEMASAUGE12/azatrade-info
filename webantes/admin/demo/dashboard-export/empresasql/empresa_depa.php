...
FROM exportacion LEFT JOIN departamento ON substring(exportacion.ubigeo,1,2) = departamento.iddepartamento WHERE exportacion.ndoc = '".$paiscode."' $querytu AND ".$wherefecha." ";
  }
  if($nombres2=="diferen"){
	  $sqlyear="SELECT
