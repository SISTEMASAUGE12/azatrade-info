...
FROM exportacion WHERE exportacion.ndoc = '".$paiscode."' $querytu $wherefecha ";
  }
  if($nombres2=="diferen"){
	  $sqlyear="SELECT
...
Sum(CASE extract(year from exportacion.fnum) WHEN '2021' THEN ".$nombres2." ELSE 0 END) AS a2021,
Sum(CASE extract(year from exportacion.fnum) WHEN '2022' THEN ".$nombres2." ELSE 0 END) AS a2022
FROM exportacion WHERE exportacion.ndoc = '".$paiscode."' $querytu $ranfecha GROUP BY exportacion.part_nandi ";
				  ...
				  <div class="col-lg-12 col-12">
					  <div class="box">
						<div class="box-header with-border">
						  <h4 class="box-title">Reporte Empresa Evolucion Mensual de Exportaciones</h4>
						</div>
							<div class="box-body">
