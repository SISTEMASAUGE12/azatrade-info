...
FROM exportacion  LEFT JOIN paises ON exportacion.cpaides = paises.idpaises WHERE substring(exportacion.ubigeo,1,2) = '".$codeid."' AND ".$wherefecha." ";
  }
  if($nombres2=="diferen"){
	  $sqlyear="SELECT
...
Sum(CASE ".$filtrofecha." WHEN '2021' THEN ".$nombres2." ELSE 0 END) AS a2021,
Sum(CASE ".$filtrofecha." WHEN '2022' THEN ".$nombres2." ELSE 0 END) AS a2022 
FROM exportacion LEFT JOIN paises ON exportacion.cpaides = paises.idpaises WHERE substring(exportacion.ubigeo,1,2) = '".$codeid."' AND ".$wherefecha." GROUP BY exportacion.cpaides,paises.espanol ORDER BY paises.espanol ASC";
						  ...
						  <h4 class="box-title">Reporte Ubigeo Evoluci&oacute;n Mensual de Exportaciones</h4>
							...
							<div class="box-body">
								<div class="form-group">
								  <label class="form-label"><b>Departamento:</b> <?=$namedato;?> <b>│ Variable #1:</b> <?=$combo;?> <b>- Variable #2:</b> <?=$combo2;?> <b>│</b> Fecha Numeraci&oacute;n <b>│ Periodo:</b> 2012 - 2021 </label>
								</div>
