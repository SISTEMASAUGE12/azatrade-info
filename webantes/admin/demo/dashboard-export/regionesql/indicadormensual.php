...
$namedato = $_POST["namedatoB"];
$codeid = $_POST["codedatoB"];
$anio = $_POST["year"];
...
$uypps = $resultado_merca -> fetchAll(PDO::FETCH_OBJ); 
if($resultado_merca -> rowCount() > 0)   { 
foreach($uypps as $fila_merca) {
		  ...
		  /*if($rmer2020=='0'  or $rmer2020 == null or $rmer2020==""){
			   $var19='0.00';
		   }else{
...
$res_generaC = $conexpg -> prepare($generalC); 
$res_generaC -> execute(); 
$opepps = $res_generaC -> fetchAll(PDO::FETCH_OBJ); 
if($res_generaC -> rowCount() > 0)   { 
foreach($opepps as $fila_pue) {
...
<div class="col-lg-12 col-12">
					  <div class="box">
						<div class="box-header with-border">
						  <h4 class="box-title">Reporte Analisis Ubigeo Indicador Mensual - Exportaciones</h4>
						</div>
							<div class="box-body">
								<div class="form-group">
								  <label class="form-label"><b>Ubigeo:</b> <?=$namedato;?> <b>│</b> Fecha Numeraci&oacute;n <b>│ Periodo:</b> <?=$anio;?> </label>
