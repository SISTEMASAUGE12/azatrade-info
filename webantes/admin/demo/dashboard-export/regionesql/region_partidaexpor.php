...
FROM exportacion WHERE substring(exportacion.ubigeo,1,2) = '".$codeid."' AND $wherefecha GROUP BY exportacion.part_nandi";
				  ...
				  <div class="col-lg-12 col-12">
					  <div class="box">
						<div class="box-header with-border">
						  <h4 class="box-title">Reporte Ubigeo Evolucion Anual de Exportaciones</h4>
						</div>
							<div class="box-body">
