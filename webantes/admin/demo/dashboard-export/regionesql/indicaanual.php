...
$namedato = trim($_POST["namedatoA"]);
$codeid = trim($_POST["codedatoA"]);

$codi1 = "extract(year from exportacion.fnum) >= '2012' AND extract(year from exportacion.fnum) <= '2022'";
...
<div class="col-lg-12 col-12">
					  <div class="box">
						<div class="box-header with-border">
						  <h4 class="box-title">Reporte Analisis Ubigeo Indicador Anual - Exportaciones</h4>
						</div>
							<div class="box-body">
								<div class="form-group">
								  <label class="form-label"><b>Ubigeo:</b> <?=$namedato;?> <b>│</b> Fecha Numeraci&oacute;n  <b>│ Periodo:</b> 2012 - 2022 </label>
