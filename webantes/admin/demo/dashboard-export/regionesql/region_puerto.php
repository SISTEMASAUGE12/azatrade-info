...
FROM exportacion LEFT JOIN puerto ON exportacion.cpuedes = puerto.idcodigo WHERE substring(exportacion.ubigeo,1,2) = '".$codeid."' AND ".$wherefecha." ";
  }
  if($nombres2=="diferen"){
	  $sqlyear="SELECT
...
FROM exportacion LEFT JOIN puerto ON exportacion.cpuedes = puerto.idcodigo WHERE substring(exportacion.ubigeo,1,2) = '".$codeid."' AND ".$wherefecha." GROUP BY exportacion.cpuedes,puerto.puerto ";
				  ...
				  <div class="col-lg-12 col-12">
					  <div class="box">
						<div class="box-header with-border">
						  <h4 class="box-title">Reporte Ubigeo Evoluci&oacute;n Mensual de Exportaciones</h4>
						</div>
							<div class="box-body">
