...
$namedato = $_POST["namedatoC"];
$codeid = $_POST["codedatoC"];
$onevar = $_POST["unavariaestaci"];
$condi1 = "AND extract(year from exportacion.fnum) >= '2012' AND extract(year from exportacion.fnum) <= '2022'";
$condiA1 = "extract(year from exportacion.fnum) >= '2012' AND extract(year from exportacion.fnum) <= '2022'";
						  ...
						  <h4 class="box-title">Reporte Ubigeo Evoluci&oacute;n Anual de Exportaciones</h4>
							...
							<div class="box-body">
								<div class="form-group">
								  <label class="form-label"><b>Ubigeo:</b> <?=$namedato;?> <b>│ Variable:</b> <?=$combo;?> <b>│</b> Fecha Numeraci&oacute;n <b>│ Periodo:</b> 2012 - 2022 </label>
								</div>
