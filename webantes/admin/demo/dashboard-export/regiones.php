			...
			<div class="col-lg-12 col-12">
					  <div class="box">
						...
						<form class="form" method="post">
							<div class="box-body">
								<h4 class="box-title text-info mb-0"><i class="ti-search me-15"></i> Busqueda por Regiones o Departamentos </h4>
								<hr class="my-15">
								<div class="row">
								  <div class="col-md-3">
									<div class="form-group">
									  <label class="form-label">Selecionar Departamento <small class="text-danger"><b>(*)</b></small> </label>
...
foreach($djfros as $filavc) {
	...
	echo "<option value=''>Sin Datos</option>";
								  ...
								  <i data-feather="map-pin"></i> Resumen</button>
									</div>
								  </div>
								</div>
							</div>
