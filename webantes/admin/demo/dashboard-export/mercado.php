  ...
  <div class="content-wrapper">
	  ...
	  <div class="content-header">
			<div class="d-flex align-items-center">
				<div class="me-auto">
					<h4 class="page-title">Mercados</h4>
			...
			<div class="col-lg-12 col-12">
					  <div class="box">
						...
						<form class="form" method="post">
							<div class="box-body">
								<h4 class="box-title text-info mb-0"><i class="ti-search me-15"></i> Seleccionar Departamento y Mercado de Busqueda </h4>
								<hr class="my-15">
								<div class="row">
								  <div class="col-md-3">
...
foreach($djfros as $filavc) {
	...
	echo "<option value=''>Sin Datos</option>";
								  ...
								  <div class="col-md-3">
									<div class="form-group">
									  <label class="form-label">Seleccionar Mercado <small class="text-danger"><b>(*)</b></small> </label>
									  <select id="mercado" name="mercado" class="form-select">
									  <option value="">Seleccionar</option>
									  <?php
$sqlmer="SELECT idpaises, espanol FROM paises ORDER BY espanol ASC";
$remv = $conexpg -> prepare($sqlmer); 
$remv -> execute(); 
$mros = $remv -> fetchAll(PDO::FETCH_OBJ); 
if($remv -> rowCount() > 0)   { 
foreach($mros as $filamer) {
	$nivt1 = $filamer -> idpaises;
	$nivt2 = ucwords(strtolower($filamer -> espanol));
			echo "<option value='$nivt1'>$nivt2</option>";
}
}else{
	echo "<option value=''>Sin Datos</option>";
								  ...
								  <i data-feather="globe"></i> Resumen</button>
									</div>
								  </div>
								</div>
							</div>
