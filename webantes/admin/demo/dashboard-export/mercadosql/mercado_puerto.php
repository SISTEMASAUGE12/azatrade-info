...
FROM exportacion LEFT JOIN puerto ON exportacion.cpuedes = puerto.idcodigo WHERE exportacion.cpaides = '".$paiscode."' AND ".$wherefecha." ".$queryu." ";
  }
  if($nombres2=="diferen"){
	  $sqlyear="SELECT
...
FROM exportacion LEFT JOIN puerto ON exportacion.cpuedes = puerto.idcodigo
...
FROM exportacion LEFT JOIN puerto ON exportacion.cpuedes = puerto.idcodigo
WHERE exportacion.cpaide = '".$paiscode."' AND ".$wherefecha." $queryu GROUP BY exportacion.cpuedes,puerto.puerto ";
						  ...
						  <h4 class="box-title">Reporte Mercado Evoluci&oacute;n Mensual de Exportaciones</h4>
							...
							<div class="box-body">
								<div class="form-group">
								  <label class="form-label"><b>Mercado:</b> <?=$paisname;?> <b>│ Departamento:</b> <?=$namedepa1;?> <b>│ Indicador #1:</b> $combo <b>- Variable #2:</b> <?=$combo2;?> <b>│</b> Fecha Numeraci&oacute;n <b>│ Periodo:</b> 2012 - 2022 </label>
								</div>
