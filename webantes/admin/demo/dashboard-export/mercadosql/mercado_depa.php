...
FROM exportacion LEFT JOIN departamento ON substring(exportacion.ubigeo,1,2) = departamento.iddepartamento WHERE exportacion.cpaides = '".$paiscode."' AND ".$wherefecha." $queryu ";
  }
  if($nombres2=="diferen"){
	  $sqlyear="SELECT
...
FROM exportacion LEFT JOIN departamento ON substring(exportacion.ubigeo,1,2) = departamento.iddepartamento
