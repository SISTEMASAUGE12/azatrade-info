...
$ubicod1 = trim($_POST["codubiB"]);
$namedepa1 = trim($_POST["namedepaB"]);
...
<div class="col-lg-12 col-12">
					  <div class="box">
						<div class="box-header with-border">
						  <h4 class="box-title">Reporte Analisis Mercado Indicador Mensual - Exportaciones</h4>
						</div>
							<div class="box-body">
								<div class="form-group">
								  <label class="form-label"><b>Mercado:</b> <?=$paisname;?> <b>│ Departamento:</b> <?=$namedepa1;?> <b>│</b> Fecha Numeraci&oacute;n <b>│ Periodo:</b> <?=$anio;?> </label>
