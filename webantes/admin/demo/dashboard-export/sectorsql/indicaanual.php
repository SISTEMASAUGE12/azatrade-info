...
$codeid = trim($_POST["namesectA"]);
$namesector = trim($_POST["namesectNAME"]);
...
$rangofecha = "extract(year from exportacion.fnum) >= '2012' AND extract(year from exportacion.fnum) <= '2022' ";
...
foreach($trepos as $fila_vfob) {
	...
	if($vfob_2021=='0' or $vfob_2021 == null){
			  $ca10 ='0';
		      }else{
...
//contamnos cantidad de departamento
	   $query_depa = "SELECT COUNT(DISTINCT departamento.nombre) as departamento, extract(year from exportacion.fnum) as anio FROM exportacion LEFT JOIN departamento ON  ((((SUBSTRING(exportacion.ubigeo,1,2))= departamento.iddepartamento))) INNER JOIN sector ON sector.partida = exportacion.part_nandi  WHERE $rangofecha $queryA AND concat(sector.tipo,sector.sector) ='".$codeid."' GROUP BY anio ORDER BY anio ASC";	
...
<div class="col-lg-12 col-12">
					  <div class="box">
						<div class="box-header with-border">
						  <h4 class="box-title">Reporte Analisis Sector Indicador Anual - Exportaciones </h4>
						</div>
							<div class="box-body">
								<div class="form-group">
								  <label class="form-label"><b>Sector:</b> <?=$namesector;?> <b>│ Departamento:</b> <?=$namedepa1;?> <b>│</b> Fecha Numeraci&oacute;n <b>│ Periodo:</b> 2012 - 2021 </label>
