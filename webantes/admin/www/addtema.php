        ...
        <div class="w3-col m12">
          <div class="w3-card-2 w3-round w3-white">
            <div class="w3-container w3-padding">
              <h6 class="w3-opacity">Usted esta aqui: Inicio /  Nuevo Temas.</h6>
...
<form name="regtema" method="post" action="insertmodiftema.php" >
<div class="col-md-12">
             <div class="form-group has-success">
                    <h5>Nombre Tema:</h5>
<input class="form-control" name="nomtema" type="text" size="30" value="<? echo $tem; ?>" required  />
    <input name="idt" type="hidden" size="15" value="<? echo $idt; ?>"  />
    </div></div>
