...
<div class="form-group">
  ...
  <div class="col-md-5">
  <input id="textinput" name="nombres" type="text" placeholder="Nombres / Apellidos" class="form-control input-md" required="">
...
<div class="form-group">
  ...
  <div class="col-md-5">
  <input id="textinput" name="correo" type="email" placeholder="Correo Electronico" class="form-control input-md" required="">
...
<div class="form-group">
  ...
  <div class="col-md-5">
  <input id="textinput" name="celular" type="text" placeholder="Numero Celular" class="form-control input-md">
...
<div class="form-group">
  ...
  <div class="col-md-6">                     
    <textarea class="form-control" id="textarea" name="comentario" rows="8" required>Describa tu comentario</textarea>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <button id="singlebutton" name="singlebutton" class="btn btn-success">Enviar Compra</button>
  </div>
</div>
