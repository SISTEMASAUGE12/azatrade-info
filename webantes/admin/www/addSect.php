        ...
        <div class="w3-col m12">
          <div class="w3-card-2 w3-round w3-white">
            <div class="w3-container w3-padding">
              <h6 class="w3-opacity">Usted esta aqui: Inicio /  Nuevo Sector.</h6>
...
<form name="regsect" method="post" action="insertmodifsect.php" >
<div class="col-md-12">
             <div class="form-group has-success">
                    <h5>Nombre Sector:</h5>
<input class="form-control" name="nomsect" type="text" size="30" value="<? echo $sec; ?>" required  />
    <input name="ase" type="hidden" size="15" value="<? echo $idse; ?>"  />
    </div></div>
