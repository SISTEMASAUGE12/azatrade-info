        ...
        <div class="w3-col m12">
          <div class="w3-card-2 w3-round w3-white">
            <div class="w3-container w3-padding">
              <h6 class="w3-opacity">Usted esta aqui: Inicio /  Nuevo Entregable.</h6>
...
<form name="regentreg" method="post" action="insertmodifentreg.php" >
<div class="col-md-12">
             <div class="form-group has-success">
                    <h5>Nombre Entregable:</h5>
<input class="form-control" name="nomentre" type="text" size="30" value="<? echo $entre; ?>" required  />
    <input name="ident" type="hidden" size="15" value="<? echo $ident; ?>"  />
    </div></div>
