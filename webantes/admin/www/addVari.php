        ...
        <div class="w3-col m12">
          <div class="w3-card-2 w3-round w3-white">
            <div class="w3-container w3-padding">
              <h6 class="w3-opacity">Usted esta aqui: Inicio /  Nuevo Variable.</h6>
...
<form name="regvaria" method="post" action="insertmodifvar.php" >
<div class="col-md-12">
             <div class="form-group has-success">
                    <h5>Nombre Variable:</h5>
<input class="form-control" name="vari" type="text" size="30" value="<? echo $var; ?>" required  />
