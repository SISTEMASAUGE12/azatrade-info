...
<?php
$sqlc="SELECT COUNT(*) as cuenta FROM pag_datapagina
WHERE pag_datapagina.estado = '0'";
...
<div class="w3-top">
 <ul class="w3-navbar w3-theme-d2 w3-left-align w3-large">
  ...
  <li class="w3-hide-small w3-dropdown-hover">
   ...
   <?php } ?>
   <li class="w3-padding-large"><center>BUSCADOR DE PÁGINAS DE INTELIGENCIA COMERCIAL</center></li>
