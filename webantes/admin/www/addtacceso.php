        ...
        <div class="w3-col m12">
          <div class="w3-card-2 w3-round w3-white">
            <div class="w3-container w3-padding">
              <h6 class="w3-opacity">Usted esta aqui: Inicio /  Nuevo Tipo Acceso.</h6>
...
<form name="regta" method="post" action="insertmodiftacceso.php" >
<div class="col-md-12">
             <div class="form-group has-success">
                    <h5>Nombre Tipo Acceso:</h5>
<input class="form-control" name="nomta" type="text" size="30" value="<? echo $tac; ?>" required  />
    <input name="ida" type="hidden" size="15" value="<? echo $ida; ?>"  />
    </div></div>
