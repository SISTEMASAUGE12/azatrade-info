        ...
        <div class="w3-col m12">
          <div class="w3-card-2 w3-round w3-white">
            <div class="w3-container w3-padding">
              <h6 class="w3-opacity">Usted esta aqui: Inicio /  Lista Tipo Datos.</h6>
...
<br>
        ...
        <p><h3>Lista Tipo Datos Registrados</h3></p>
        </center><br>
        <!--<hr class="w3-clear">-->
...
<table class="table table-striped table-hover">
					<thead>
                    <tr>
						<th><a href="addtdato.php"><button class="btn btn-success"><i class="fa fa-edit"></i> Nuevo</button></a></th>
					  </tr>
					  <tr>
						<th>Codigo</th>
						<th>Tipo Dato</th>
