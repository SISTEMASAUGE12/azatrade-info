        ...
        <div class="w3-col m12">
          <div class="w3-card-2 w3-round w3-white">
            <div class="w3-container w3-padding">
              <h6 class="w3-opacity">Usted esta aqui: Inicio /  Nuevo Alcance.</h6>
...
<form name="regalca" method="post" action="insertmodifalca.php" >
<div class="col-md-12">
             <div class="form-group has-success">
                    <h5>Nombre Alcance:</h5>
<input class="form-control" name="nomalcan" type="text" size="30" value="<? echo $alca; ?>" required  />
    <input name="idal" type="hidden" size="15" value="<? echo $idal; ?>"  />
    </div></div>
