        ...
        <div class="w3-col m12">
          <div class="w3-card-2 w3-round w3-white">
            <div class="w3-container w3-padding">
              <h6 class="w3-opacity">Usted esta aqui: Inicio /  Nuevo Idioma.</h6>
...
<form name="regidio" method="post" action="insertmodifidio.php" >
<div class="col-md-12">
             <div class="form-group has-success">
                    <h5>Nombre Idioma:</h5>
<input class="form-control" name="nomidio" type="text" size="30" value="<? echo $idio; ?>" required  />
    <input name="ididiom" type="hidden" size="15" value="<? echo $id_idio; ?>"  />
    </div></div>
