        ...
        <div class="w3-col m12">
          <div class="w3-card-2 w3-round w3-white">
            <div class="w3-container w3-padding">
              <h6 class="w3-opacity">Usted esta aqui: Inicio /  Nuevo Tipo Dato.</h6>
...
<form name="regtema" method="post" action="insertmodiftdato.php" >
<div class="col-md-12">
             <div class="form-group has-success">
                    <h5>Nombre Tipo Dato:</h5>
<input class="form-control" name="nomdato" type="text" size="30" value="<? echo $dat; ?>" required  />
    <input name="idd" type="hidden" size="15" value="<? echo $idd; ?>"  />
    </div></div>
