...
extract(year from exportacion.fnum) <= '2019'";
	  ...
	  $query1 = "SELECT rp.varia_filtro, rp.codigo as tipo, rp.descripcion, rp.sector, rp.anio1 AS a2012, rp.anio2 AS a2013, rp.anio3 AS a2014, rp.anio4 AS a2015, rp.anio5 AS a2016, rp.anio6 AS a2017, rp.anio7 AS a2018, rp.anio8 AS a2019, rp.variauno, rp.variados FROM resumen_sectores AS rp WHERE rp.varia_filtro = '$nombres2' AND rp.codigo <> 'Total'";
