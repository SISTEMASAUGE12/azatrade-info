...
<body>
<br /><br />
<input class="form-control btn-primary" type="button" value="C&aacute;lculo de Costo de Importaci&oacute;n. Paso : 2 de 12" />
...
FROM
cos_producto AS prod
INNER JOIN cos_prod_detalle AS prodet ON prod.id_prod = prodet.id_prod
WHERE
prod.id_prod = '$codi'
ORDER BY
