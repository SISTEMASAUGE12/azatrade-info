...
$sum="SELECT
sum(cos_prod_detalle.cantidad) as cantidades,
sum(cos_prod_detalle.peso_total_kg) as pesototal
FROM
cos_prod_detalle
WHERE
...
<br /><br />
<input class="form-control btn-primary" type="button" value="C&aacute;lculo de Costo de Importaci&oacute;n. Paso : 6 de 12" />
...
<table class="table table-hover" style='font-size:80%'>
 ...
 <tr>
  ...
  $sqlvc="SELECT
cos_empaque.id_em,
cos_empaque.id_prod_em,
cos_empaque.producto_em,
cos_empaque.unid_em,
cos_empaque.cantidad_em,
cos_empaque.dim_ancho_em,
cos_empaque.dim_largo_em,
cos_empaque.dim_alto_em,
cos_empaque.unid_volum_em,
cos_empaque.vol_unid_em,
cos_empaque.precio_empaque,
cos_empaque.costo_empaque,
cos_empaque.precio_embalaje,
cos_empaque.costo_embalaje,
cos_empaque.kilo_embalaje,
cos_empaque.peso_embalaje
FROM
cos_empaque
WHERE
cos_empaque.id_prod_em = '$codi'
ORDER BY
cos_empaque.id_em ASC ";
...
if (mysql_num_rows($rsnvc) > 0){
  ...
  <?php
  $sqlpaleti="SELECT
cos_paletizacion.id_pale,
cos_paletizacion.id_prod_pale,
cos_paletizacion.producto_pale,
cos_paletizacion.unid_carga_pale,
cos_paletizacion.cantidad_pale,
cos_paletizacion.dim_ancho_pale,
cos_paletizacion.dim_largo_pale,
cos_paletizacion.dim_alto_pale,
cos_paletizacion.vol_unid_pale,
cos_paletizacion.tota_volum_pale,
cos_paletizacion.costo_unita_pale,
cos_paletizacion.tota_unita_pale,
cos_paletizacion.peso_pale,
cos_paletizacion.tota_peso_pale
FROM
cos_paletizacion
WHERE
cos_paletizacion.id_prod_pale = '$codi'
ORDER BY
cos_paletizacion.id_pale ASC ";
