...
<br /><br />
<input class="form-control btn-primary" type="button" value="C&aacute;lculo de Costo de Importaci&oacute;n. Paso : 5 de 12" />
...
cos_prod_detalle.agrupa_contenedor
FROM
cos_prod_detalle
WHERE
cos_prod_detalle.id_prod = '$codigo'
GROUP BY
cos_prod_detalle.id_prod,
cos_prod_detalle.agrupa_contenedor";
