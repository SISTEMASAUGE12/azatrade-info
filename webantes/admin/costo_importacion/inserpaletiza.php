...
$rsd=("delete from cos_paletizacion where id_prod_pale='$codigo'");
...
$Sqlinsert1="insert into cos_paletizacion (id_prod_pale, producto_pale, unid_carga_pale, cantidad_pale, dim_ancho_pale, dim_largo_pale, dim_alto_pale, vol_unid_pale, tota_volum_pale, costo_unita_pale, tota_unita_pale, peso_pale, tota_peso_pale)  values ('$codigo', '$nomprodu1', '$carga1', '$canti1', '$dancho1', '$dlargo1', '$dalto1', '$vol_unid1', '$totavol_unid1', '$costo_pale1', '$totacosto_pale1', '$peso_pale1', '$totapeso_pale1' )";
...
$Sqlinsert2="insert into cos_paletizacion (id_prod_pale, producto_pale, unid_carga_pale, cantidad_pale, dim_ancho_pale, dim_largo_pale, dim_alto_pale, vol_unid_pale, tota_volum_pale, costo_unita_pale, tota_unita_pale, peso_pale, tota_peso_pale)  values ('$codigo', '$nomprodu2', '$carga1', '$canti2', '$dancho2', '$dlargo2', '$dalto2', '$vol_unid2', '$totavol_unid2', '$costo_pale2', '$totacosto_pale2', '$peso_pale2', '$totapeso_pale2' )";
...
$Sqlinsert3="insert into cos_paletizacion (id_prod_pale, producto_pale, unid_carga_pale, cantidad_pale, dim_ancho_pale, dim_largo_pale, dim_alto_pale, vol_unid_pale, tota_volum_pale, costo_unita_pale, tota_unita_pale, peso_pale, tota_peso_pale)  values ('$codigo', '$nomprodu3', '$carga1', '$canti3', '$dancho3', '$dlargo3', '$dalto3', '$vol_unid3', '$totavol_unid3', '$costo_pale3', '$totacosto_pale3', '$peso_pale3', '$totapeso_pale3' )";
...
$Sqlinsert4="insert into cos_paletizacion (id_prod_pale, producto_pale, unid_carga_pale, cantidad_pale, dim_ancho_pale, dim_largo_pale, dim_alto_pale, vol_unid_pale, tota_volum_pale, costo_unita_pale, tota_unita_pale, peso_pale, tota_peso_pale)  values ('$codigo', '$nomprodu4', '$carga4', '$canti4', '$dancho4', '$dlargo4', '$dalto4', '$vol_unid4', '$totavol_unid4', '$costo_pale4', '$totacosto_pale4', '$peso_pale4', '$totapeso_pale4' )";
...
$Sqlinsert5="insert into cos_paletizacion (id_prod_pale, producto_pale, unid_carga_pale, cantidad_pale, dim_ancho_pale, dim_largo_pale, dim_alto_pale, vol_unid_pale, tota_volum_pale, costo_unita_pale, tota_unita_pale, peso_pale, tota_peso_pale)  values ('$codigo', '$nomprodu5', '$carga5', '$canti5', '$dancho5', '$dlargo5', '$dalto5', '$vol_unid5', '$totavol_uni5', '$costo_pale5', '$totacosto_pale5', '$peso_pale5', '$totapeso_pale5' )";
   mysql_query($Sqlinsert5,$link) or die (mysql_error());

}

header("Location: listaunita.php?conte=$codigo");
