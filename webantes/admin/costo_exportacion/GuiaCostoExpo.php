...
function calcular(){
	...
	v5 = document.producto.valorfact_5.value;
	 ...
	 document.producto.porc_costo_1.value = ((tota1 * -1) / ( total_t * -1)) * 100;
	 document.producto.porc_costo_2.value = ((tota2 * -1) / ( total_t * -1)) * 100;
	 document.producto.porc_costo_3.value = ((tota3 * -1) / ( total_t * -1)) * 100;
	 document.producto.porc_costo_4.value = ((tota4 * -1) / ( total_t * -1)) * 100;
	 document.producto.porc_costo_5.value = ((tota5 * -1) / ( total_t * -1)) * 100;
...
<input class="form-control btn-primary" type="button" value="C&aacute;lculo de Costo de Exportaci&oacute;n. Paso : 1 de 8" />
...
<!--<td> --><input class="form-control" name="precioventalocal1" type="hidden" placeholder="0.00" onkeypress="return NumCheck(event, this)" value="0.00" /><!--<td> -->
...
<!--<td> --><input class="form-control" name="precioventalocal2" type="hidden" placeholder="0.00" onkeypress="return NumCheck(event, this)" value="0.00" /><!--<td> -->
...
<!--<td> --><input class="form-control" name="precioventalocal3" type="hidden" placeholder="0.00" onkeypress="return NumCheck(event, this)" value="0.00" /><!--<td> -->
...
<!--<td> --><input class="form-control" name="precioventalocal4" type="hidden" placeholder="0.00" onkeypress="return NumCheck(event, this)" value="0.00" /><!--<td> -->
...
<!--<td> --><input class="form-control" name="precioventalocal5" type="hidden" placeholder="0.00" onkeypress="return NumCheck(event, this)" value="0.00" /><!--<td> -->
...
<tr>
<td colspan="13" align="center"><input class="btn btn-success" name="guardar" type="submit" value=" Validar / Uniendo Datos"  /></td>
</tr>
</table>
</form>
</body>
