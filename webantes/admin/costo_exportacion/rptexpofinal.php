...
css.setAttribute("href", "bootstrap/bootstrap-3.3.5-dist/css/bootstrap.min.css");
...
if (mysql_num_rows($rsnter3) > 0){
  ...
  ?>
   ...
   <?php if($btn_vista=='no'){?>
    ...
    <input class="btn btn-primary" type="button" value="Volver a Consultar" name="Modificar" onclick="history.back()" />
    <?php } ?>
   ...
   <a href="rptexpofinal_excel.php?expo=<?php echo "$codigox"; ?>"><img src="img/EXCEL.png" width="35" title="Exportar a Excel"/></a>
  </center> 
