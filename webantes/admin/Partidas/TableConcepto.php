	...
	<head>
		...
		<script type="text/javascript" language="javascript" >
			$(document).ready(function() {
				...
				processing: true,
				serverSide: true,
				ajax: "tableconceptodata.php", // json datasource
            ...
            <table id="employee-grid"  class="table table-striped table-hover " cellspacing="0" width="100%" style='font-size:80%'>
				...
				<thead>
					<tr>
                        ...
                        <td  valign="middle" width="80"><input type="text" id="12" class="employee-search-input datepicker" ></td>
						<td  valign="middle" width="80"><input type="text" id="13" class="employee-search-input datepicker" ></td>
                        <td  valign="middle" width="80"><input type="text" id="14" class="employee-search-input datepicker" ></td>
						<!-- <td><input type="text" id="6" class="employee-search-input" ></td> -->
					</tr>
				</thead>
			</table>
