	...
	<head>
		...
		<script type="text/javascript" language="javascript" >
			$(document).ready(function() {
				...
				processing: true,
				serverSide: true,
				ajax: "tableDimerprodatas.php", // json datasource
            ...
            <table id="employee-grid"  class="table table-striped table-hover " cellspacing="0" width="100%" style='font-size:80%'>
				...
				<thead>
					<tr>
						...
						<td  valign="middle" width="80"><input type="text" id="8" class="employee-search-input datepicker" ></td>
                        <td  valign="middle" width="80"><input type="text" id="9" class="employee-search-input datepicker" ></td>
