...
<center>
<form name="regupdate"  method="post" action='updatepuntaje.php'>
...
echo "</tr>";
	while($rowprod = mysql_fetch_array($rsprod)){
		...
		echo "<tr>";
		echo "<td align='right' bgcolor='#F1F1F1'>Nombre Del Producto:</td>";
...
echo "<tr>";
echo "<td colspan='7' align='right' bgcolor='#D8D8D8'>
<h3>Codigo Generado: #$idreg </h3><br> <em>Guarde Su Codigo para Futuras Consultas</em>
</td>";
echo "</tr>";
echo "<tr>";
...
if (mysql_num_rows($rsnxf) > 0){
	...
	echo "<table border='0' class='table table-hover'>";
	echo "<tr>";
	echo "<td colspan='7' align='center' bgcolor='#D8D8D8'>Asignacion de Puntaje</td>";
	echo "</tr>";
	echo "<tr>";
	echo "<td align='center' bgcolor='#F1F1F1'>Indicador</td>";
	...
	while($rowqx = mysql_fetch_array($rsnxq)){
		...
		echo "<td align='center'><input type='text' name='porcen[]' value='$xpor' size='2'><b>%</b> </td>";
		echo "<td align='center'><input type='text' name='val1[]' value='$v1' size='2'></td>";
		if($pa2!=''){
		echo "<td align='center'><input type='text' name='val2[]' value='$v2' size='2'></td>";
		}
		if($pa3!=''){
		echo "<td align='center'><input type='text' name='val3[]' value='$v3' size='2'></td>";
		}
		if($pa4!=''){
		echo "<td align='center'><input type='text' name='val4[]' value='$v4' size='2'></td>";
		}
		if($pa5!=''){
		echo "<td align='center'><input type='text' name='val5[]' value='$v5' size='2'></td>";
		...
		echo"<tr>";
	    echo"<td colspan='7' align='right'><font color='#FF0000'><em>Ingrese Datos en Porcentaje(*) - Maximo al 100% / Indique Orden Paises(*)</em></font></td>";
		echo"</tr>";
		echo "</table>";
		}
...
if (mysql_num_rows($rsnxfr) > 0){
	...
	echo "<table border='0' class='table table-hover'>";
	echo "<tr>";
	echo "<td colspan='7' align='center' bgcolor='#D8D8D8'>Resultado Final</td>";
	echo "</tr>";
	echo "<tr>";
	echo "<td align='center' bgcolor='#F1F1F1'>Indicador</td>";
	...
	while($rowr = mysql_fetch_array($rsnr)){
		...
		echo "<td align='center'><input type='text' name='re1' value='$r1' size='2'> </td>";
		if($pa2x!=''){
		echo "<td align='center'><input type='text' name='re2' value='$r2' size='2'></td>";
		}
		if($pa3x!=''){
		echo "<td align='center'><input type='text' name='re3' value='$r3' size='2'></td>";
		}
		if($pa4x!=''){
		echo "<td align='center'><input type='text' name='re4' value='$r4' size='2'></td>";
		}
		if($pa5x!=''){
		echo "<td align='center'><input type='text' name='re5' value='$r5' size='2'></td>";
		}
...
merca_pais.pais ASC" ) ; 
  ...
  <br>
<p>
<input class="btn btn-primary" name="boton" type="submit" value="2# Paso / Registar - Generar Informe"  />
</p>
