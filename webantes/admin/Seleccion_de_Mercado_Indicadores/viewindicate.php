...
<body>
<section>
    <h4>Lista de Indicadores Nuevos</h4>
    <br />
    <a href="reg_indicatorNew.php"><input type="button" value="REGISTRAR NUEVO INDICADOR" id="" class="btn btn-primary"/></a>
    <br />
    <br />
