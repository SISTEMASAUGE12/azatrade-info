...
//seleccionamos indicador
	$sqlpa="SELECT mt.id_inf, ti2.id_indi, merca_indicadores.nom_indicador FROM merca_temp_info AS mt INNER JOIN merca_temp_indi2 AS ti2 ON mt.id_inf = ti2.codigo INNER JOIN merca_indicadores ON ti2.id_indi = merca_indicadores.cod_indicador WHERE mt.id_inf = '$codi' AND ti2.id_indi = '$codi_indica' GROUP BY mt.id_inf, ti2.id_indi, merca_indicadores.nom_indicador";
	$xrsa = mysql_query($sqlpa);
if (mysql_num_rows($xrsa) > 0){
	while($rowsa = mysql_fetch_array($xrsa)){
		$aa=$rowsa["nom_indicador"];
		}
	}
//fin indicador seleccionado
echo"<center><b><em>$aa</em></b></center>";
...
WHERE
merca_datamercado.cod_indicador = '$codi_indica' AND
