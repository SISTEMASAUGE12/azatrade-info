...
<ul style="display:none">
        <a href="viewindicate.php"><li>Nuevo Indicador</li></a>
       <!-- <a href="viewproindicate"><li>Indicador Propio del Producto</li></a> -->
...
<li>Selecci&oacute;n de Mercado <img src="img/producci.png" width="18" height="17">
  <ul style="display:none">
        <a href="consultmarketpro.php"><li>Ingresar Datos </li></a>
      
    </ul>
</li>
<li>Consultas <img src="img/consult.png" width="18" height="17">
<ul style="display:none">
        <a href="viewconsul.php"><li>Consultar Datos </li></a>
        <a href="viewtem.php"><li>Consultar Indicadores</li></a>
