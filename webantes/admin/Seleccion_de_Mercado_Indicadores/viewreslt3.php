...
<input class="btn btn-primary" name="botonx" type="submit" value="Exportar Informe"  />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="btn btn-primary" name="resetea" onclick="javascript:history.back()" type="button" value="Volver a Consultar" />
</p>
