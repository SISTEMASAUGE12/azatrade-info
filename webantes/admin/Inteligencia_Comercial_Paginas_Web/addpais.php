...
function valida(regpais) {
    if (regpais.nompais.value.length < 1){
	
		alert("Ingrese Nombre del Pais");
		return false;
	}
	return true;
}
...
<br>
<center>
<form name="regpais" method="post" action="insertmodifpais.php"  onSubmit="return valida(this);">
<table border="1" bordercolor="#00CCFF" style='background-color:#CEECF5;
   ...
   <tr onmouseover='NavRollOver(this)' onmouseout='NavRollOut(this)'>
    <td bgcolor="#279CC9" colspan="2" align="center"><b><font color="#FFFFFF">Registrar Pais</font></b></td>
  </tr>
  <tr onmouseover='NavRollOver(this)' onmouseout='NavRollOut(this)'>
    <td>Nombre Pais:</td>
    <td><input name="nompais" type="text" size="30" value="<? echo $pai; ?>"  />
    <input name="idp" type="hidden" size="15" value="<? echo $idp; ?>"  /></td>
  </tr>
