...
$sqlp="SELECT id, tipo_acceso
FROM pag_tipo_acceso
WHERE id='$cod'";
...
function valida(regta) {
    if (regta.nomta.value.length < 1){
	
		alert("Ingrese Tipo Acceso");
		return false;
	}
	return true;
}
...
<br>
<center>
<form name="regta" method="post" action="insertmodiftacceso.php"  onSubmit="return valida(this);">
<table border="1" bordercolor="#00CCFF" style='background-color:#CEECF5;
   ...
   <tr onmouseover='NavRollOver(this)' onmouseout='NavRollOut(this)'>
    <td bgcolor="#279CC9" colspan="2" align="center"><b><font color="#FFFFFF">Registrar Tipo Acceso</font></b></td>
  </tr>
  <tr onmouseover='NavRollOver(this)' onmouseout='NavRollOut(this)'>
    <td>Tipo Acceso:</td>
    <td><input name="nomta" type="text" size="30" value="<? echo $tac; ?>"  />
    <input name="ida" type="hidden" size="15" value="<? echo $ida; ?>"  /></td>
  </tr>
