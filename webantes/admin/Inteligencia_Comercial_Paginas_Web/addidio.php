...
function valida(regidio) {
    if (regidio.nomidio.value.length < 1){
...
<br>
<center>
<form name="regidio" method="post" action="insertmodifidio.php"  onSubmit="return valida(this);">
<table border="1" bordercolor="#00CCFF" style='background-color:#CEECF5;
   ...
   <tr onmouseover='NavRollOver(this)' onmouseout='NavRollOut(this)'>
    <td bgcolor="#279CC9" colspan="2" align="center"><b><font color="#FFFFFF">Registrar Idiomas</font></b></td>
  </tr>
  <tr onmouseover='NavRollOver(this)' onmouseout='NavRollOut(this)'>
    <td>Nombre Idioma:</td>
    <td><input name="nomidio" type="text" size="30" value="<? echo $idio; ?>"  />
    <input name="ididiom" type="hidden" size="15" value="<? echo $id_idio; ?>"  /></td>
  </tr>
