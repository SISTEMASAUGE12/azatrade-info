...
function valida(regentreg) {
    if (regentreg.nomentre.value.length < 1){
	
		alert("Ingrese Nombre Entregable");
		return false;
	}
	return true;
}
...
<br>
<center>
<form name="regentreg" method="post" action="insertmodifentreg.php"  onSubmit="return valida(this);">
<table border="1" bordercolor="#00CCFF" style='background-color:#CEECF5;
   ...
   <tr onmouseover='NavRollOver(this)' onmouseout='NavRollOut(this)'>
    <td bgcolor="#279CC9" colspan="2" align="center"><b><font color="#FFFFFF">Registrar Entregables</font></b></td>
  </tr>
  <tr onmouseover='NavRollOver(this)' onmouseout='NavRollOut(this)'>
    <td>Nombre Entregable:</td>
    <td><input name="nomentre" type="text" size="30" value="<? echo $entre; ?>"  />
    <input name="ident" type="hidden" size="15" value="<? echo $ident; ?>"  /></td>
  </tr>
