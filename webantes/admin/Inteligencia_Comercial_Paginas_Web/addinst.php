...
function valida(reginst) {
    if (reginst.nominst.value.length < 1){
...
<br>
<center>
<form name="reginst" method="post" action="insertmodifinst.php"  onSubmit="return valida(this);">
<table border="1" bordercolor="#00CCFF" style='background-color:#CEECF5;
   ...
   <tr onmouseover='NavRollOver(this)' onmouseout='NavRollOut(this)'>
    <td bgcolor="#279CC9" colspan="2" align="center"><b><font color="#FFFFFF">Registrar Intituciones</font></b></td>
  </tr>
  <tr onmouseover='NavRollOver(this)' onmouseout='NavRollOut(this)'>
    <td>Nombre Institución:</td>
    <td><input name="nominst" type="text" size="30" value="<? echo $ins; ?>"  />
    <input name="idi" type="hidden" size="15" value="<? echo $idi; ?>"  /></td>
  </tr>
