...
function valida(regtema) {
    if (regtema.nomtema.value.length < 1){
...
<br>
<center>
<form name="regtema" method="post" action="insertmodiftema.php"  onSubmit="return valida(this);">
<table border="1" bordercolor="#00CCFF" style='background-color:#CEECF5;
   ...
   <tr onmouseover='NavRollOver(this)' onmouseout='NavRollOut(this)'>
    <td bgcolor="#279CC9" colspan="2" align="center"><b><font color="#FFFFFF">Registrar Temas</font></b></td>
  </tr>
  <tr onmouseover='NavRollOver(this)' onmouseout='NavRollOut(this)'>
    <td>Nombre del Tema:</td>
    <td><input name="nomtema" type="text" size="30" value="<? echo $tem; ?>"  />
    <input name="idt" type="hidden" size="15" value="<? echo $idt; ?>"  /></td>
  </tr>
