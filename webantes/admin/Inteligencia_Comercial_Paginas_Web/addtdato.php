...
function valida(regtdato) {
    if (regtdato.nomdato.value.length < 1){
	
		alert("Ingrese Tipo Dato");
		return false;
	}
	return true;
}
...
<br>
<center>
<form name="regtdato" method="post" action="insertmodiftdato.php"  onSubmit="return valida(this);">
<table border="1" bordercolor="#00CCFF" style='background-color:#CEECF5;
   ...
   <tr onmouseover='NavRollOver(this)' onmouseout='NavRollOut(this)'>
    <td bgcolor="#279CC9" colspan="2" align="center"><b><font color="#FFFFFF">Registrar Tipo Dato</font></b></td>
  </tr>
  <tr onmouseover='NavRollOver(this)' onmouseout='NavRollOut(this)'>
    <td>Nombre Tipo Dato:</td>
    <td><input name="nomdato" type="text" size="30" value="<? echo $dat; ?>"  />
    <input name="idd" type="hidden" size="15" value="<? echo $idd; ?>"  /></td>
  </tr>
