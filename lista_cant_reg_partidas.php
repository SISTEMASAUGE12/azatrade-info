...
$cxreg = "SELECT COUNT(iduser) as total FROM partidas_masiva WHERE iduser='$dato2' ";
...
SUM(CASE WHEN YEAR(e.FNUM) = '2024' THEN 1 ELSE 0 END) AS x2024
...
$sqlinsert="INSERT INTO `partidas_masiva` (`iduser`, `partida`, `detalle`, `anio12`, `anio13`, `anio14`, `anio15`, `anio16`, `anio17`, `anio18`, `anio19`, `anio20`, `anio21`, `anio22`, `anio23`, `anio24`) VALUES ('".$dato2."','".$nurqs1."', '".$nurqs2."', '".$nurqs3."', '".$nurqs4."', '".$nurqs5."', '".$nurqs6."', '".$nurqs7."', '".$nurqs8."', '".$nurqs9."', '".$nurqs10."', '".$nurqs11."', '".$nurqs12."', '".$nurqs13."', '".$nurqs14."', '".$nurqs15."')";
...
if($rdrpt -> rowCount() > 0) { 
	...
	$sqlinsert="INSERT INTO busquedas(fechareg, horareg, pagek, origen, seccion, palabra, codeuser)values(now(), now(), 'www.azatrade.info/descargar_cant_partidas', 'Exportacion', 'Descarga Masiva', 'Partida: $dato', '$dato2' )";
	$stmt = $conexpg->prepare($sqlinsert);
    $stmt->execute();
	}
...
<table class="table table-hover" id="">
	...
	$tbb16 = $frvpt -> anio24;
		...
		if($ttot < '100000'){
			$pitu = " href='descarga_partidamasiva.php?dat1=$tbb2' target='_blank' ";
		}else{
			$pitu = "";
		}
...
?>
	<tr>
		...
		<td><?=$tbb2;?></td>
		<td><?=$tbb3;?></td>
		<td><a href="descarga_partidamasiva.php?dat1=<?=$tbb2;?>&dat2=2012" target="_blank"><?=$tbb4;?></a></td>
		<td><a href="descarga_partidamasiva.php?dat1=<?=$tbb2;?>&dat2=2013" target="_blank"><?=$tbb5;?></a></td>
		<td><a href="descarga_partidamasiva.php?dat1=<?=$tbb2;?>&dat2=2014" target="_blank"><?=$tbb6;?></a></td>
		<td><a href="descarga_partidamasiva.php?dat1=<?=$tbb2;?>&dat2=2015" target="_blank"><?=$tbb7;?></a></td>
		<td><a href="descarga_partidamasiva.php?dat1=<?=$tbb2;?>&dat2=2016" target="_blank"><?=$tbb8;?></a></td>
		<td><a href="descarga_partidamasiva.php?dat1=<?=$tbb2;?>&dat2=2017" target="_blank"><?=$tbb9;?></a></td>
		<td><a href="descarga_partidamasiva.php?dat1=<?=$tbb2;?>&dat2=2018" target="_blank"><?=$tbb10;?></a></td>
		<td><a href="descarga_partidamasiva.php?dat1=<?=$tbb2;?>&dat2=2019" target="_blank"><?=$tbb11;?></a></td>
		<td><a href="descarga_partidamasiva.php?dat1=<?=$tbb2;?>&dat2=2020" target="_blank"><?=$tbb12;?></a></td>
		<td><a href="descarga_partidamasiva.php?dat1=<?=$tbb2;?>&dat2=2021" target="_blank"><?=$tbb13;?></a></td>
		<td><a href="descarga_partidamasiva.php?dat1=<?=$tbb2;?>&dat2=2022" target="_blank"><?=$tbb14;?></a></td>
		<td><a href="descarga_partidamasiva.php?dat1=<?=$tbb2;?>&dat2=2023" target="_blank"><?=$tbb15;?></a></td>
		<td><a href="descarga_partidamasiva.php?dat1=<?=$tbb2;?>&dat2=2024" target="_blank"><?=$tbb16;?></a></td>
		<td><a <?=$pitu;?> ><?=$ttot;?></a></td>
		...
		<td>
			<a href="deleteparti_masiva.php?dat1=<?=$tbb1;?>&dat2=<?=$tbb2;?>" class="btn btn-danger btn-sm" > Quitar </a>
			
			<a href="updateparti_masiva.php?dat1=<?=$tbb2;?>&dat2=<?=$dato2;?>" class="btn btn-info btn-sm">Actualizar</a>
