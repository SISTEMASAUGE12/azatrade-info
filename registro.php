			...
			<div class="container login-container">
				<div class="row">
					<div class="col-lg-6 mx-auto">
						...
						<div class="alert alert-rounded alert-danger alert-dismissible">
						<i class="fa fa-exclamation-circle" style="color: #ef8495;"></i>
						<span><strong>Alerta!</strong> Error marque el ReCaptcha intentelo nuevamente.</span>
					</div>
					<?php } if($msnn=="repfail2"){ ?>
						<div class="alert alert-rounded alert-danger alert-dismissible">
						<i class="fa fa-exclamation-circle" style="color: #ef8495;"></i>
						<span><strong>Alerta!</strong> Error en ReCaptcha, no paso la validacion, intentelo nuevamente.</span>
					</div>
					<?php } ?>
						...
						<div class="row">
							...
							<div class="col-md-12">
								...
								<form method="post" action="validareg/" name="formulario" id="formulario">
                             ...
                             <div
                class="g-recaptcha"
                data-sitekey="6LcR6EIoAAAAAIg0KabV-IW4ZWHIq_RKkTt7Ztth">
            </div>
                        </div>

									<div class="form-footer mb-2">
										<button type="submit" name="submit" class="btn btn-dark btn-md w-100 mr-0"> Registrarme </button>
									</div>
