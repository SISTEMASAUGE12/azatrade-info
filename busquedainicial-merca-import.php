...
if($rdrpt -> rowCount() > 0) { 
	...
	$sqlinsert="INSERT INTO busquedas(fechareg, horareg, pagek, origen, seccion, palabra, codeuser)values(now(), now(), 'www.azatrade.info/importacion', 'Importacion', 'Mercado', '$dato2 - $dato', '$dato4' )";
