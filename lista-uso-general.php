...
if($rdrpt -> rowCount() > 0) { 
	...
	$sqlinsert="INSERT INTO busquedas(fechareg, horareg, pagek, origen, seccion, palabra, codeuser)values(now(), now(), 'www.azatrade.info/uso_importacion?dat=$dato&year=$dato2', 'Importacion', 'Uso Economico', '$dato - $dato2', '$dato3' )";
