...
$date_past = date('Y-m-d', $date_past);
	  ...
	  $qk13 = " AND MATCH (e.dcom,e.dmer2,e.dmer3,e.dmer4,e.DMER5) AGAINST ('$dato15' IN
BOOLEAN MODE) ";
	  ...
	  $qk13 = " AND MATCH (e.dcom,e.dmer2,e.dmer3,e.dmer4,e.DMER5) AGAINST ('$dato17' IN
BOOLEAN MODE) ";
	  ...
	  //$qk14 = " AND MATCH (e.dcom,e.dmer2,e.dmer3,e.dmer4,e.DMER5) AGAINST ('$dato15 $dato17' IN BOOLEAN MODE) ";
	  //$qk14 = " AND (CONCAT(e.dcom,' ',e.dmer2,' ',e.dmer3,' ',e.dmer4,' ',e.DMER5) LIKE '%$dato15%') OR (CONCAT(e.dcom,' ',e.dmer2,' ',e.dmer3,' ',e.dmer4,' ',e.DMER5) LIKE '%$dato17%') ";
	  $qk14 = " AND e.dcom LIKE '%$dato15%' OR e.dcom LIKE '%$dato17%' OR 
	  e.dmer2 LIKE '%$dato15%' OR e.dmer2 LIKE '%$dato17%' OR
      e.dmer3 LIKE '%$dato15%' OR e.dmer3 LIKE '%$dato17%' OR
      e.dmer4 LIKE '%$dato15%' OR e.dmer4 LIKE '%$dato17%' OR
      e.DMER5 LIKE '%$dato15%' OR e.DMER5 LIKE '%$dato17%' ";
	  ...
	  }else if($dato15!="" and $dato17!="" and $dato16=="y"){ //contiene ambras palabra
	  $qk14 = " AND CONCAT(e.dcom,' ',e.dmer2,' ',e.dmer3,' ',e.dmer4,' ',e.DMER5) LIKE '%$dato15%$dato17%' ";
		  $titvar14  = " | Palabra Comercial : $dato15 - $dato17 ";
	  }else{
	  $qk14 = "";
		  $titvar14  = "xx2";
...
e.CPAIDES,
e.UBIGEO,
substr(e.UBIGEO,1,2) as depa,
substr(e.UBIGEO,1,4) as provi,
e.UBIGEO as dist,
e.CADU,
e.CAGE,
e.NDCL,
...
CONCAT(e.dcom,' ',e.dmer2,' ',e.dmer3,' ',e.dmer4,' ',e.DMER5) as descri
...
if($rdrpt -> rowCount() > 0) { 
	...
	/*$sqlinsert="INSERT INTO busquedas(fechareg, horareg, pagek, origen, seccion, palabra, codeuser)values(now(), now(), 'www.azatrade.info/busqueda-avanzada-expo', 'Exportacion', 'Busqueda Avanzada', '$titvar1 $titvar2 $titvar3 $titvar4 $titvar5 $titvar6 $titvar7 $titvar8 $titvar9 $titvar10 $titvar11 $titvar12 $titvar13 $titvar14', '$dato' )";
	...
	<nav class="toolbox sticky-header" data-sticky-options="{'mobile': true}">
							...
							<div>
								<h5 align="center">Reporte de b&uacute;squeda Avanzada - Filtros: Año: <?=$dato10;?> <?=$titvar1;?> <?=$titvar2;?>  <?=$titvar3;?> <?=$titvar4;?> <?=$titvar5;?> <?=$titvar6;?> <?=$titvar7;?> <?=$titvar8;?> <?=$titvar9;?> <?=$titvar10;?><?=$titvar11;?> <?=$titvar12;?> <?=$titvar13;?> <?=$titvar14;?>  </h5>
							</div>
                        </nav>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title"> <b>Partida:</b> <?=$tbb2;?> | <b>Periodo : <?=$dato10;?> </b> </h4>
						...
						<div class="col-xl-3 col-md-6">
							<div class="info-box info-box-icon-left">
								...
								<div class="info-box-content">
									<h4>Ver Detalle</h4>
									<p><a href="ver-resumen-detalle-partida?dat=<?=$dato;?>&year=<?=$dato10;?>&pk=<?=$tbb2;?>" target="_blank"> <button class="btn btn-outline-primary btn-rounded btn-md">Ver Reporte</button></a></p>
								</div>
							</div>
						</div>
						<div class="col-xl-3 col-md-6">
						...
						<div class="col-xl-3 col-md-6">
							<div class="info-box info-box-icon-left">
								...
								<div class="info-box-content">
									...
									<p><a href="partida-indicador-mensual?dat=<?=$tbb2;?>&year=<?=$dato10;?>" target="_blank"> <button class="btn btn-outline-primary btn-rounded btn-md">Ver Reporte</button></a></p>
								</div>
							</div>
						</div>
						<div class="col-xl-3 col-md-6">
							<div class="info-box info-box-icon-left">
								...
								<div class="info-box-content">
									...
									<p><a href="partida-estacionalidad?dat=<?=$tbb2;?>&year=<?=$dato10;?>&var=FOBUSD" target="_blank"> <button class="btn btn-outline-primary btn-rounded btn-md">Ver Reporte</button></a></p>
								</div>
							</div>
						</div>
						<div class="col-xl-3 col-md-6">
							<div class="info-box info-box-icon-left">
								...
								<div class="info-box-content">
									...
									<p><a href="partida-mercados?dat=<?=$tbb2;?>&year=<?=$dato10;?>&var=FOBUSD" target="_blank"> <button class="btn btn-outline-primary btn-rounded btn-md">Ver Reporte</button></a></p>
								</div>
							</div>
						</div>
						<div class="col-xl-3 col-md-6">
							<div class="info-box info-box-icon-left">
								...
								<div class="info-box-content">
									<h4>Departamentos</h4>
									<p><a href="partida-region?dat=<?=$tbb2;?>&year=<?=$dato10;?>&var=FOBUSD" target="_blank"> <button class="btn btn-outline-primary btn-rounded btn-md">Ver Reporte</button></a></p>
								</div>
							</div>
						</div>
						<div class="col-xl-3 col-md-6">
							<div class="info-box info-box-icon-left">
								...
								<div class="info-box-content">
									...
									<p><a href="partida-empresas?dat=<?=$tbb2;?>&year=<?=$dato10;?>&var=FOBUSD" target="_blank"> <button class="btn btn-outline-primary btn-rounded btn-md">Ver Reporte</button></a></p>
								</div>
							</div>
						</div>
						<div class="col-xl-3 col-md-6">
							<div class="info-box info-box-icon-left">
								...
								<div class="info-box-content">
									...
									<p><a href="partida-agente-aduanas?dat=<?=$tbb2;?>&year=<?=$dato10;?>&var=FOBUSD" target="_blank"> <button class="btn btn-outline-primary btn-rounded btn-md">Ver Reporte</button></a></p>
								</div>
							</div>
						</div>
						<div class="col-xl-3 col-md-6">
							<div class="info-box info-box-icon-left">
								...
								<div class="info-box-content">
									<h4>Aduanas</h4>
									<p><a href="partida-aduanas?dat=<?=$tbb2;?>&year=<?=$dato10;?>&var=FOBUSD" target="_blank"> <button class="btn btn-outline-primary btn-rounded btn-md">Ver Reporte</button></a></p>
								</div>
							</div>
						</div>
