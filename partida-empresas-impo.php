                 ...
                 <div class="info-boxes-container row row-joined mb-2 font2">
                    ...
                    <div class="info-box info-box-icon-left col-lg-4">
                        ...
                        <div class="info-box-content">
                            ...
                            <p class="text-body"> │ Valor FOB USD │ </p>
                        </div>
                    </div>
                    <div class="info-box info-box-icon-left col-lg-4">
                    ...
                    <div class="col-lg-12" style="padding: 28px;">
						...
						<table id='datatablese' class='table table-striped table-no-bordered table-hover compact' cellspacing='0' width='100%' style='width:100%'>
                          ...
                          <tr>
							...
							<tbody>
						<?php								
$sqtrp="SELECT e.dnombre, e.libr_tribu, 
...
SUM(CASE e.aniofn WHEN '2024' THEN $varianom ELSE 0 END) AS a2024
FROM GranResumenImport_PowerBI as e WHERE e.part_nandi = '$code1' AND aniofn >= '2012' AND aniofn <= '$aniogen' GROUP BY e.dnombre, e.libr_tribu ORDER BY a2023 DESC";
...
foreach($ggts as $dsx) {
	...
	$listval12 = $dsx -> a2022;
	$listval13 = $dsx -> a2023;
	$listval14 = $dsx -> libr_tribu;
	$listval15 = $dsx -> a2024;
	
	$totq1 = $totq1 + $listval2;
	$totq2 = $totq2 + $listval3;
	$totq3 = $totq3 + $listval4;
	$totq4 = $totq4 + $listval5;
	$totq5 = $totq5 + $listval6;
	$totq6 = $totq6 + $listval7;
	$totq7 = $totq7 + $listval8;
	$totq8 = $totq8 + $listval9;
	$totq9 = $totq9 + $listval10;
	$totq10 = $totq10 + $listval11;
	$totq11 = $totq11 + $listval12;
	$totq12 = $totq12 + $listval13;
	$totq13 = $totq13 + $listval15;
	...
	echo "<td>".number_format($listval6,2)."</td>";
	echo "<td>".number_format($listval7,2)."</td>";
	echo "<td>".number_format($listval8,2)."</td>";
	echo "<td>".number_format($listval9,2)."</td>";
	echo "<td>".number_format($listval10,2)."</td>";
	echo "<td>".number_format($listval11,2)."</td>";
	echo "<td>".number_format($listval12,2)."</td>";
	echo "<td>".number_format($listval13,2)."</td>";
	echo "<td>".number_format($listval15,2)."</td>";
	echo "</tr>";
}
	echo "<tr>";
	echo "<td> </td>";
	...
	echo "<td>".number_format($totq4,2)."</td>";
	echo "<td>".number_format($totq5,2)."</td>";
	echo "<td>".number_format($totq6,2)."</td>";
	echo "<td>".number_format($totq7,2)."</td>";
	echo "<td>".number_format($totq8,2)."</td>";
	echo "<td>".number_format($totq9,2)."</td>";
	echo "<td>".number_format($totq10,2)."</td>";
	echo "<td>".number_format($totq11,2)."</td>";
	echo "<td>".number_format($totq12,2)."</td>";
	echo "<td>".number_format($totq13,2)."</td>";
	echo "</tr>";
}else{
