...
$sqllist= "SELECT YEAR(r.fech_ingsi) as aniofn, MONTH(r.fech_ingsi) as mes, CONVERT(MONTH(r.fech_ingsi),UNSIGNED INTEGER) as mesfn, sum(r.fob_dolpol) AS VFOBSERDOL, 
count(r.part_nandi) AS cantreg 
          FROM importacion AS r 
	WHERE YEAR(r.fech_ingsi) = '$code2' AND r.part_nandi = '$code3' AND CONCAT(r.desc_comer,r.desc_fopre,r.desc_matco,r.desc_otros,r.desc_usoap) like '%$code1%'	
...
foreach($glds as $shht) {
 ...
 if($filaff1=="1"){
                        ...
                        <div class="product-default">
                            <div class="product-details">
                                ...
                                <div class="product-action">
                                    ...
                                    <a href="ver-detalle-uso-general?dat=<?=$code1;?>&year=<?=$code2;?>&pk=<?=$code3;?>&flat=<?=$filaff1;?>" target="_blank" class="btn btn-dark product-type-simple btn-sm" title="ver Detalle" style="color: white;"><i class="fa fa-eye"></i> <span>VER</span></a> 
	...
	<center><a href='descarga_partidamasiva_import.php?dat1=<?=$code3;?>&dat2=<?=$code2;?>' target='_blank' class='btn btn-primary'>Descarga un año</a> </center>
	</div>
	<div class='col-lg-3'><br>
	<center><a href='descarga_partidamasiva_import.php?dat1=<?=$code3;?>' target='_blank' class='btn btn-primary'>Descarga todo los años</a></center>
	</div>
		<div class='col-lg-3'></div>
	</div>
				</section>
