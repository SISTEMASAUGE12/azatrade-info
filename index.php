			...
			<div class="tabs tabs-simple">
                    ...
                    <div class="header-right w-lg-max pl-2" >
						...
						<div class="header-searchp header-iconp header-search-inlinep header-search-categoryp w-lg-max" style="display: flex; justify-content: center;">
                                <div class="header-search-wrappep">
									<!--<div class=""> -->
									<input type="hidden" id="usera" name="usera" value="<?=$_SESSION['codusuario'];?>" >
                    ...
                    <div class="header-right w-lg-max pl-2">
                        <div class="header-searchp header-iconp header-search-inlinep header-search-categoryp w-lg-max" style="display: flex; justify-content: center;">
							...
							<div class="col-lg-12">
                                <div class="header-search-wrappep">
									<input type="hidden" id="userb" name="userb" value="<?=$_SESSION['codusuario'];?>" >
	...
	<select id='cate2' name="cate2" lang="es" style="border-radius: 80px 20px 5px 90px; background-color:#F4F4F4;">
        <option value=''>- Buscar Mercado -</option>
                    ...
                    <div class="header-right w-lg-max pl-2">
                        <div class="header-searchp header-iconp header-search-inlinep header-search-categoryp w-lg-max" style="display: flex; justify-content: center;">
                                <div class="header-search-wrappep">
									<input type="hidden" id="userc" name="userc" value="<?=$_SESSION['codusuario'];?>" >
                    ...
                    <div class="header-right w-lg-max pl-2">
                        <div class="header-searchp header-iconp header-search-inlinep header-search-categoryp w-lg-max" style="display: flex; justify-content: center;">
                                <div class="header-search-wrappep">
									...
									<input type="hidden" id="userd" name="userd" value="<?=$_SESSION['codusuario'];?>" >
									
									
										<select class="form-select" aria-label="Default select example" id='qp' name="qp" lang="es" style="border-radius: 80px 20px 5px 90px; background-color:#F4F4F4; height: 40px;">
        <option value='' style="width: 10px;">- Buscar Partida -</option>
     </select>
                    ...
                    <div class="header-right w-lg-max pl-2">
                        <div class="header-searchp header-iconp header-search-inlinep header-search-categoryp w-lg-max" style="display: flex; justify-content: center;">
                                <div class="header-search-wrappep">
									<input type="hidden" id="usere" name="usere" value="<?=$_SESSION['codusuario'];?>" >
                    ...
                    <div class="header-right w-lg-max pl-2">
                        <div class="header-searchp header-iconp header-search-inlinep header-search-categoryp w-lg-max" style="display: flex; justify-content: center;">
                                <div class="header-search-wrappep">
                                    ...
                                    <div class="select-customp">
										<input type="hidden" id="userf" name="userf" value="<?=$_SESSION['codusuario'];?>" >
...
$sflt = "SELECT CONCAT(g.tipo,g.sector) as codsec, CONCAT(g.tipo,' - ',g.sector) as sector FROM sectores AS g GROUP BY g.tipo,g.sector ORDER BY g.sector";
	...
	$filaff7x1 = $shht -> sector;
							...
							<div class="product-default inner-quickview inner-icon">
                                ...
                                <div class="product-details">
                                    ...
                                    <h3 class="product-title"> <a href="partida-detalle?dat=<?=$filaff2;?>&year=2022" target="_blank" style="color: #2927D5;" >Partida: <?=$filaff2;?> </a> </h3>
                                    <div class="price-box">
							...
							<p align='right'> <a href='sectores?dat=<?=$filaff6x1;?>&year=<?=$filaff7x1;?>' target="_blank" class='btn btn-dark btn-md'><i
													class="fa fa-arrow-right"></i> <b>VER M&Aacute;S</b></a> </p>
...
foreach($glds as $shht) {
	...
	$filaff7x2 = $shht -> sector;
							...
							<p align='right'> <a href='sectores?dat=<?=$filaff6x2;?>&year=<?=$filaff7x2;?>' target="_blank" class='btn btn-dark btn-md'><i class="fa fa-arrow-right"></i> <b>VER M&Aacute;S</b></a> </p>
...
foreach($glds as $shht) {
	...
	$filaff7x3 = $shht -> sector;
							...
							<p align='right'> <a href='sectores?dat=<?=$filaff6x3;?>&year=<?=$filaff7x3;?>' target="_blank" class='btn btn-dark btn-md'><i class="fa fa-arrow-right"></i> <b>VER M&Aacute;S</b></a> </p>
...
foreach($glds as $shht) {
	...
	$filaff7x4 = $shht -> sector;
							...
							<p align='right'> <a href='sectores?dat=<?=$filaff6x4;?>&year=<?=$filaff7x4;?>' target="_blank" class='btn btn-dark btn-md'><i class="fa fa-arrow-right"></i> <b>VER M&Aacute;S</b></a> </p>
...
foreach($glds as $shht) {
	...
	$filaff7x5 = $shht -> sector;
							...
							<p align='right'> <a href='sectores?dat=<?=$filaff6x5;?>&year=<?=$filaff7x5;?>' target="_blank" class='btn btn-dark btn-md'><i class="fa fa-arrow-right"></i> <b>VER M&Aacute;S</b></a> </p>
...
foreach($glds as $shht) {
	...
	$filaff7x6 = $shht -> sector;
							...
							<p align='right'> <a href='sectores?dat=<?=$filaff6x6;?>&year=<?=$filaff7x6;?>' target="_blank" class='btn btn-dark btn-md'><i class="fa fa-arrow-right"></i> <b>VER M&Aacute;S</b></a> </p>
...
foreach($glds as $shht) {
	...
	$filaff7x7 = $shht -> sector;
							...
							<p align='right'> <a href='sectores?dat=<?=$filaff6x7;?>&year=<?=$filaff7x7;?>' target="_blank" class='btn btn-dark btn-md'><i class="fa fa-arrow-right"></i> <b>VER M&Aacute;S</b></a> </p>
...
foreach($glds as $shht) {
	...
	$filaff7x8 = $shht -> sector;
							...
							<p align='right'> <a href='sectores?dat=<?=$filaff6x8;?>&year=<?=$filaff7x8;?>' target="_blank" class='btn btn-dark btn-md'><i class="fa fa-arrow-right"></i> <b>VER M&Aacute;S</b></a> </p>
...
foreach($glds as $shht) {
	...
	$filaff7x9 = $shht -> sector;
							...
							<p align='right'> <a href='sectores?dat=<?=$filaff6x9;?>&year=<?=$filaff7x9;?>' target="_blank" class='btn btn-dark btn-md'><i class="fa fa-arrow-right"></i> <b>VER M&Aacute;S</b></a> </p>
...
foreach($glds as $shht) {
	...
	$filaff7x10 = $shht -> sector;
							...
							<p align='right'> <a href='sectores?dat=<?=$filaff6x10;?>&year=<?=$filaff7x10;?>' target="_blank" class='btn btn-dark btn-md'><i class="fa fa-arrow-right"></i> <b>VER M&Aacute;S</b></a> </p>
...
foreach($glds as $shht) {
	...
	$filaff7x11 = $shht -> sector;
							...
							<p align='right'> <a href='sectores?dat=<?=$filaff6x11;?>&year=<?=$filaff7x11;?>' target="_blank" class='btn btn-dark btn-md'><i class="fa fa-arrow-right"></i> <b>VER M&Aacute;S</b></a> </p>
...
foreach($glds as $shht) {
	...
	$filaff7x12 = $shht -> sector;
							...
							<p align='right'> <a href='sectores?dat=<?=$filaff6x12;?>&year=<?=$filaff7x12;?>' target="_blank" class='btn btn-dark btn-md'><i class="fa fa-arrow-right"></i> <b>VER M&Aacute;S</b></a> </p>
...
foreach($glds as $shht) {
	...
	$filaff7x13 = $shht -> sector;
							...
							<p align='right'> <a href='sectores?dat=<?=$filaff6x13;?>&year=<?=$filaff7x13;?>' target="_blank" class='btn btn-dark btn-md'><i class="fa fa-arrow-right"></i> <b>VER M&Aacute;S</b></a> </p>
...
foreach($glds as $shht) {
	...
	$filaff7x14 = $shht -> sector;
							...
							<p align='right'> <a href='sectores?dat=<?=$filaff6x14;?>&year=<?=$filaff7x14;?>' target="_blank" class='btn btn-dark btn-md'><i class="fa fa-arrow-right"></i> <b>VER M&Aacute;S</b></a> </p>
...
foreach($glds as $shht) {
	...
	$filaff7x15 = $shht -> sector;
							...
							<p align='right'> <a href='sectores?dat=<?=$filaff6x15;?>&year=<?=$filaff7x15;?>' target="_blank" class='btn btn-dark btn-md'><i class="fa fa-arrow-right"></i> <b>VER M&Aacute;S</b></a> </p>
...
foreach($glds as $shht) {
	...
	$filaff7x16 = $shht -> sector;
							...
							<p align='right'> <a href='sectores?dat=<?=$filaff6x16;?>&year=<?=$filaff7x16;?>' target="_blank" class='btn btn-dark btn-md'><i class="fa fa-arrow-right"></i> <b>VER M&Aacute;S</b></a> </p>
   ...
   $("#cate2").select2({
	...
	<script>
      ...
      function load(page){
		  ...
		  codereg = document.getElementById("usera").value;
		  
        var parametros = {"action" : "ajax", "page" : page};
        $("#loader").fadeIn();
        $.ajax({
		  url : 'busquedainicial.php?data='+product+'&year='+proyear+'&ptipo1='+ptipo1+'&use='+codereg,
          data : parametros,
		...
		function load2(page){
		  ...
		  codereg = document.getElementById("userb").value;
		  
        var parametros = {"action" : "ajax", "page" : page};
        $("#loader").fadeIn();
        $.ajax({
		  url : 'busquedainicial-merca.php?data='+product+'&year='+proyear+'&ptipo1='+ptipo1+'&use='+codereg,
          data : parametros,
          beforeSend:function(objeto){
            $("#loader").fadeIn();
          },
		...
		function load3(page){
		  ...
		  codereg = document.getElementById("userc").value;
		  
        var parametros = {"action" : "ajax", "page" : page};
        $("#loader").fadeIn();
        $.ajax({
		  url : 'busquedainicial-empresas.php?data='+product+'&year='+proyear+'&use='+codereg,
          data : parametros,
          beforeSend:function(objeto){
            $("#loader").fadeIn();
          },
		...
		function load4(page){
		  ...
		  codereg = document.getElementById("usere").value;
		  
        var parametros = {"action" : "ajax", "page" : page};
        $("#loader").fadeIn();
        $.ajax({
		  url : 'busquedainicial-region.php?data='+product+'&year='+proyear+'&use='+codereg,
          data : parametros,
          beforeSend:function(objeto){
            $("#loader").fadeIn();
          },
		...
		function load5(page){
		  ...
		  codereg = document.getElementById("userf").value;
			
        var parametros = {"action" : "ajax", "page" : page};
        $("#loader").fadeIn();
        $.ajax({
		  url : 'busquedainicial-sector.php?data='+product+'&year='+proyear+'&use='+codereg,
          data : parametros,
          beforeSend:function(objeto){
            $("#loader").fadeIn();
          },
		...
		function load6(page){
		  ...
		  codereg = document.getElementById("userd").value;
		  
        var parametros = {"action" : "ajax", "page" : page};
        $("#loader").fadeIn();
        $.ajax({
		  url : 'busquedainicial-partida.php?data='+product+'&year='+proyear+'&use='+codereg,
          data : parametros,
          beforeSend:function(objeto){
            $("#loader").fadeIn();
          },
