...
if($rdrpt -> rowCount() > 0) { 
	...
	$sqlinsert="INSERT INTO busquedas(fechareg, horareg, pagek, origen, seccion, palabra, codeuser)values(now(), now(), 'www.azatrade.info/sectores?dat=$dato&year=$dato2', 'Sector', 'Sector', '$dato - $dato2', '$dato3' )";
    ...
    <div class="col-6 col-sm-4 col-md-3">
                                <div class="product-default">
                                    ...
                                    <div class="product-details">
										...
										<a href="partida-detalle?dat=<?=$filaff2;?>&year=2022" target="_blank" style="color: #2927D5;" >Partida: <?=$filaff2;?> </a> 
										</h3>
                                        ...
                                        <div class="btn-list"><br>
                                            <a href="sector-producto?dat=<?=$filaff2;?>&pk=<?=$filaff1;?>" target="_blank" class="btn btn-dark btn-md"><i
