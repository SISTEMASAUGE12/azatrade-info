                 ...
                 <div class="info-boxes-container row row-joined mb-2 font2">
                    ...
                    <div class="info-box info-box-icon-left col-lg-4">
                        ...
                        <div class="info-box-content">
                            ...
                            <p class="text-body">│ Valor FOB USD │ Mensual</p>
                        </div>
                    </div>
                    <div class="info-box info-box-icon-left col-lg-4">
...
sum(e.VFOB) as vfobserdol, 
sum(e.VPESNET) as vpesnet,
(e.VFOB/e.VPESNET) as precio,
COUNT(e.part_nandi) as cantreg,
Count(DISTINCT e.libr_tribu) as cant_emp,
Count(DISTINCT e.pais_orige) as cant_mer,
Count(DISTINCT e.cadu_manif) as cant_adua
FROM GranResumenImport_PowerBI as e WHERE aniofn = '$code2' AND e.part_nandi='$code1' GROUP BY mes ORDER BY mes";
